 ...
 * page. Hard refresh on `/discover` and `/collectibles` renders the full-page
 * panel in `children`. Face peeks (`/reputation`, `/feed`, `/endorsements`,
 * `/standing/…`) redirect to the profile — overlay-only, same as Standing.
 */
