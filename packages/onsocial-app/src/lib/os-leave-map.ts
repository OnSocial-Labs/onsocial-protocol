...
export const OS_LEAVE_MAP = [
  ...
  },
  {
    ...
    modelParent: OS_INDEX_LEAVE_HREF,
    verdict: 'needs-decision',
    note: 'Launcher app `drops`, but dock leave goes to Market, not Home.',
  },
  {
    id: 'discover-index',
    place: 'Discover',
  ...
  },
  {
    ...
    modelParent: OS_INDEX_LEAVE_HREF,
    verdict: 'mismatch',
    note: '`MessagesFallback` has no dockBack for the loading beat.',
  },
  {
    id: 'activity-index',
    place: 'Activity',
  ...
  },
  {
    ...
    verdict: 'matches',
    note: 'Holder leave is the vault (`hubPageBackHref`). Visitor leave is Hubs.',
  },
  {
    id: 'hub-create',
    place: 'Open a hub',
  ...
  },
  {
    ...
    parent: APP_MARKET_PATH,
    verdict: 'matches',
    note: 'Loaded visitor leave is Market. Holder leave is the vault.',
  },
  {
    id: 'drop-loading',
    ...
    dockBack: true,
    parent: APP_MARKET_PATH,
    modelParent: 'holder vault or Market',
    verdict: 'mismatch',
    note: 'Loading always uses Market; holders flash the visitor parent.',
  },
  {
    id: 'series-loading',
    ...
    dockBack: true,
    parent: APP_MARKET_PATH,
    modelParent: 'holder vault or creator shop',
    verdict: 'mismatch',
    note: 'Loaded series is holder-aware; loading is always Market.',
  },
  {
    id: 'door-loading',
    ...
    dockBack: true,
    parent: APP_MARKET_PATH,
    modelParent: '/collection/[collectionId]',
    verdict: 'mismatch',
    note: 'Loaded door leaves to the drop; loading leaves to Market.',
  },
  {
...
/** Indexes that already follow Home leave. Drops is listed separately. */
