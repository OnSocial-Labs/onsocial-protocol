...
export const txToastConfirming = {
  ...
  fundingGroupStorage: 'Confirming guild storage…',
  grantingGroupStorage: 'Confirming member storage…',
  settingGroupStorageDefault: 'Confirming default storage…',
  revokingGroupStorage: 'Confirming remove storage…',
  ...
  reposting: 'Confirming repost…',
  unreposting: 'Confirming undo…',
  ...
  banningGuildMember: 'Confirming ban…',
  unbanningGuildMember: 'Confirming unban…',
  ...
  supportingEndorsement: 'Confirming endorsement support…',
  ...
  changingScarcePrice: 'Confirming price…',
  creatingCollection: 'Starting your drop…',
  mintingCollection: 'Minting…',
  redeemingTicket: 'Confirming check-in…',
  redeemingCoupon: 'Confirming redeem…',
  addingDoorStaff: 'Adding door staff…',
  removingDoorStaff: 'Removing door staff…',
  updatingDoorStaff: 'Updating door staff…',
  ...
  extendingTicketEntry: 'Postponing entry…',
  ...
  creatingToken: 'Creating your token…',
  thankingToken: 'Sending thanks…',
  savingTokenIcon: 'Saving icon…',
  lockingTokenAdmin: 'Locking admin…',
  ...
  transferringScarce: 'Confirming transfer…',
  burningScarce: 'Confirming burn…',
  ...
  allowingAppAccess: 'Confirming access…',
  renewingAppAccess: 'Confirming renewal…',
  removingAppAccess: 'Confirming removal…',
} as const;
...
export const txToastPending = {
  ...
  fundingGroupStorage: 'Funding guild storage…',
  grantingGroupStorage: 'Adding member storage…',
  settingGroupStorageDefault: 'Updating default storage…',
  revokingGroupStorage: 'Removing member storage…',
  ...
  banningGuildMember: 'Banning member…',
  unbanningGuildMember: 'Unbanning member…',
  ...
  supportingEndorsement: 'Supporting endorsement…',
  listingScarce: 'Listing…',
  sellingScarce: 'Listing for sale…',
  transferringScarce: 'Sending scarce…',
  ...
  changingScarcePrice: 'Changing price…',
...
export const txToastSuccess = {
  ...
  groupStorageFunded: 'Guild storage funded.',
  groupStorageGranted: 'Guild storage added for members.',
  groupStorageDefaultSet: 'Default member storage updated.',
  groupStorageRevoked: 'Member storage removed.',
  ...
  guildMemberBanned: 'Member banned.',
  guildMemberUnbanned: 'Member unbanned.',
  ...
  scarcePriceChanged: 'Price updated.',
  ...
  tokenCreated: 'Your token is live.',
  tokenThanksSent: 'Thanks sent.',
  tokenIconUpdated: 'Icon updated.',
  tokenAdminLocked: 'Admin locked.',
  ...
  appAccessRemoved: 'App access removed.',
...
export const txToastError = {
  ...
  groupStorageFundFailed: 'Could not fund guild storage.',
  groupStorageGrantFailed: 'Could not add guild storage for members.',
  groupStorageDefaultFailed: 'Could not update default member storage.',
  groupStorageRevokeFailed: 'Could not remove member storage.',
  ...
  unrepostFailed: 'Could not undo repost.',
  ...
  guildBanMemberFailed: 'Could not ban member.',
  guildUnbanMemberFailed: 'Could not unban member.',
  ...
  endorsementMissing: 'That endorsement is gone.',
  endorsementShareFailed: 'Could not share this endorsement.',
  recoveryCodeCopyFailed: 'Could not copy recovery code.',
  supportFailed: 'Could not send support.',
  endorsementSupportFailed: 'Could not support this endorsement.',
  ...
  changeScarcePriceFailed: 'Could not change the price.',
  listScarceAuctionFailed: 'Could not list auction.',
  tokenCreateFailed: 'Could not create the token.',
  tokenThankFailed: 'Could not send thanks.',
  tokenIconFailed: 'Could not update the icon.',
  tokenLockFailed: 'Could not lock admin.',
  createCollectionFailed: 'Could not start the drop.',
  mintCollectionFailed: 'Could not mint from the drop.',
  redeemTicketFailed: 'Could not check in.',
  redeemCouponFailed: 'Could not redeem.',
  addDoorStaffFailed: 'Could not add door staff.',
  removeDoorStaffFailed: 'Could not remove door staff.',
  updateDoorStaffFailed: 'Could not update door staff.',
  ...
  pauseEventFailed: 'Could not pause the event.',
  resumeEventFailed: 'Could not resume the event.',
  deleteEventFailed: 'Could not delete the event.',
  cancelCollectionFailed: 'Could not cancel the drop.',
  extendTicketEntryFailed: 'Could not postpone entry.',
  ...
  transferScarceFailed: 'Could not send scarce.',
  burnScarceFailed: 'Could not burn scarce.',
  ...
  removeAppAccessFailed: 'Could not remove app access.',
  allowAppAccessFailed: 'Could not allow app access.',
} as const;
