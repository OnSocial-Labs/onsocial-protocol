...
export const txToastConfirming = {
  ...
  fundingGroupStorage: 'Confirming group storage…',
...
export const txToastPending = {
  ...
  fundingGroupStorage: 'Funding group storage…',
...
export const txToastSuccess = {
  ...
  groupStorageFunded: 'Group storage funded.',
  groupStorageGranted: 'Group storage added for members.',
  ...
  endorsementSupportSent: (name: string) =>
    `Supported ${name}'s endorsement.`,
...
export const txToastError = {
  ...
  groupStorageFundFailed: 'Could not fund group storage.',
  groupStorageGrantFailed: 'Could not add group storage for members.',
