...
export function getScarcesParityCases(
  ...
  const cases: Array<{
    ...
    {
      name: 'fund app pool',
      action: { type: 'fund_app_pool', app_id: 'my-app' },
      expectedAction: { type: 'fund_app_pool', app_id: 'my-app' },
    },
    {
    ...
    },
    {
      ...
      action: { type: 'register_app', app_id: 'my-app' },
      expectedAction: { type: 'register_app', app_id: 'my-app' },
    },
    {
    ...
    // ── App admin ───────────────────────────────────────────────────────────
    {
      ...
      action: { type: 'set_app_config', app_id: 'my-app' },
      expectedAction: { type: 'set_app_config', app_id: 'my-app' },
    },
    {
