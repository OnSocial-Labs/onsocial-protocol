    ...
    <section className="relative min-h-[80vh] flex items-center justify-center pt-24 md:pt-16">
      ...
      <div
        ...
        style={{
          ...
          opacity: 0.04,
          maskImage: 'radial-gradient(ellipse 70% 60% at 50% 40%, black 20%, transparent 70%), linear-gradient(to bottom, black 40%, transparent 85%)',
          WebkitMaskImage: 'radial-gradient(ellipse 70% 60% at 50% 40%, black 20%, transparent 70%), linear-gradient(to bottom, black 40%, transparent 85%)',
