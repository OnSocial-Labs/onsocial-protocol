...
const ON_RAMPS: OnRamp[] = [
  ...
  },
  {
    ...
    badge: 'Wallet app',
    body: 'For apps where users sign in with a NEAR wallet and approve their own writes.',
    steps: [
      'Connect a NEAR wallet and sign the gateway challenge.',
      'Set the returned token with os.auth.setToken.',
      'Write with the SDK. Use os.social.getOne for immediate confirmation.',
      'Use os.query directly for feeds, search, history, and analytics.',
    ],
    accent: 'green',
    icon: Wallet,
    href: '/playground',
