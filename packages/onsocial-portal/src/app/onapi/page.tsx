			...
			<div className="container mx-auto px-4 max-w-4xl">
				...
				>
					...
					<p className="text-lg text-muted-foreground max-w-xl mx-auto">
						Purchase credits with $SOCIAL to unlock higher rate limits and advanced query features for your dapp.
					</p>
				</motion.div>
						...
						<div className="border border-border/50 rounded-2xl p-6 bg-muted/30">
							...
							<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
								<div className="flex flex-col items-center text-center">
									...
									<h4 className="text-sm font-semibold mb-1">1. Purchase Credits</h4>
									<p className="text-xs text-muted-foreground">
										Send $SOCIAL tokens to the staking contract with a credits action
									</p>
								</div>
								<div className="flex flex-col items-center text-center">
								...
								<div className="flex flex-col items-center text-center">
									...
									<p className="text-xs text-muted-foreground">
										Credits are debited per API call at your tier&apos;s rate limits
									</p>
								</div>
							</div>
						</div>
						...
						>
							...
							<div className="space-y-3 flex-1">
								...
								<div className="flex justify-between text-sm">
									...
									<span className="font-medium">{tier.complexity.toLocaleString()}</span>
								</div>
								<div className="flex justify-between text-sm">
				...
				>
					<div className="flex items-start gap-2 text-xs text-muted-foreground">
						...
						<span>
							Free tier is available now. Pro and Scale tiers will launch when credit purchasing is
							integrated with the gateway. All prices denominated in $SOCIAL tokens at market rate via
							Ref Finance oracle.
						</span>
					</div>
				</motion.div>
