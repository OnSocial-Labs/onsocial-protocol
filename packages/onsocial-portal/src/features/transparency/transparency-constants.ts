...
export const INITIAL_SUPPLY_YOCTO = INITIAL_SUPPLY_TOKENS * 10n ** TOKEN_DECIMALS;
export const SUPPLY_OVERVIEW_FRACTION_DIGITS = 2;
export const SUPPLY_OVERVIEW_SCALE = 10n ** BigInt(SUPPLY_OVERVIEW_FRACTION_DIGITS);
