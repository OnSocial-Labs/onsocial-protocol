...
export const profilePageMobileGutterClass = 'max-md:px-3';

/** Extra inset for profile content below a full-bleed banner on mobile. */
export const profilePageMobileContentInsetClass = 'max-md:px-2';

/** Profile identity / stance content (inset below banner on mobile). */
export const profilePageHorizontalPaddingClass = 'px-4 md:px-5 max-md:px-2';
...
export const profilePageMobileContentMarginClass = 'max-md:mx-2';
