...
--   2b. scarces_app_stats_hot           — same shape, 30d sales/drops/mints window
...
-- ────────────────────────────────────────────────────────────────────────────
-- 2b. scarces_app_stats_hot — per-app rollup with 30-day trade/mint window
-- ────────────────────────────────────────────────────────────────────────────
-- Same columns as scarces_app_stats. Drops / mints / sales count only events
-- in the last 30 days (NEAR block_timestamp is nanoseconds since epoch).
-- Holders + live listings stay as current snapshots. Rank Discover hub peeks
-- by sales_volume DESC on this view so lifetime whales do not dominate.
-- ────────────────────────────────────────────────────────────────────────────
