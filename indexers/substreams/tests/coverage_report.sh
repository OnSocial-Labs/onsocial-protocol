...
count_op "contractUpdates" "contract_upgrade"
count_op "contractUpdates" "wnear_account_set"
...
count_op "rewardsEvents" "APP_REGISTERED"
count_op "rewardsEvents" "APP_UPDATED"
