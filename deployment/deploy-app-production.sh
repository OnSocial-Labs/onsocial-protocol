...
ssh "${SSH_OPTIONS[@]}" "root@$SERVER_IP" bash -s \
  ...
  SEASON_SETTLEMENT_ADMIN_KEY="$(fetch_secret SEASON_SETTLEMENT_ADMIN_KEY)"
  TELEGRAM_BOT_TOKEN="$(fetch_secret "$TELEGRAM_BOT_SECRET_NAME")"
  ADMIN_SECRET="$(fetch_secret ADMIN_SECRET)"
  ADMIN_WALLETS="$(fetch_secret ADMIN_WALLETS || true)"
  ONSOCIAL_PORTAL_REWARDS_API_KEY="$(fetch_secret ONSOCIAL_PORTAL_REWARDS_API_KEY)"
  ONSOCIAL_PORTAL_REWARDS_APP_ID="${ONSOCIAL_PORTAL_REWARDS_APP_ID:-onsocial_portal}"

  JWT_SECRET="$(fetch_secret JWT_SECRET)"
  LIGHTHOUSE_API_KEY="$(fetch_secret LIGHTHOUSE_API_KEY)"
  REVOLUT_ENVIRONMENT="$(fetch_secret REVOLUT_ENVIRONMENT || true)"
  REVOLUT_SECRET_KEY_SANDBOX="$(fetch_secret REVOLUT_SECRET_KEY_SANDBOX || true)"
  REVOLUT_PUBLIC_KEY_SANDBOX="$(fetch_secret REVOLUT_PUBLIC_KEY_SANDBOX || true)"
  REVOLUT_WEBHOOK_SIGNING_SECRET_SANDBOX="$(fetch_secret REVOLUT_WEBHOOK_SIGNING_SECRET_SANDBOX || true)"
  REVOLUT_PRO_VARIATION_ID_SANDBOX="$(fetch_secret REVOLUT_PRO_VARIATION_ID_SANDBOX || true)"
  REVOLUT_SCALE_VARIATION_ID_SANDBOX="$(fetch_secret REVOLUT_SCALE_VARIATION_ID_SANDBOX || true)"
  REVOLUT_API_URL_SANDBOX="$(fetch_secret REVOLUT_API_URL_SANDBOX || true)"
  REVOLUT_API_VERSION_SANDBOX="$(fetch_secret REVOLUT_API_VERSION_SANDBOX || true)"
  REVOLUT_SECRET_KEY_PRODUCTION="$(fetch_secret REVOLUT_SECRET_KEY_PRODUCTION || true)"
  REVOLUT_PUBLIC_KEY_PRODUCTION="$(fetch_secret REVOLUT_PUBLIC_KEY_PRODUCTION || true)"
  REVOLUT_WEBHOOK_SIGNING_SECRET_PRODUCTION="$(fetch_secret REVOLUT_WEBHOOK_SIGNING_SECRET_PRODUCTION || true)"
  REVOLUT_PRO_VARIATION_ID_PRODUCTION="$(fetch_secret REVOLUT_PRO_VARIATION_ID_PRODUCTION || true)"
  REVOLUT_SCALE_VARIATION_ID_PRODUCTION="$(fetch_secret REVOLUT_SCALE_VARIATION_ID_PRODUCTION || true)"
  REVOLUT_API_URL_PRODUCTION="$(fetch_secret REVOLUT_API_URL_PRODUCTION || true)"
  REVOLUT_API_VERSION_PRODUCTION="$(fetch_secret REVOLUT_API_VERSION_PRODUCTION || true)"
  REVOLUT_SECRET_KEY="$(fetch_secret REVOLUT_SECRET_KEY || true)"
  REVOLUT_PUBLIC_KEY="$(fetch_secret REVOLUT_PUBLIC_KEY || true)"
  REVOLUT_WEBHOOK_SIGNING_SECRET="$(fetch_secret REVOLUT_WEBHOOK_SIGNING_SECRET || true)"
  REVOLUT_PRO_VARIATION_ID="$(fetch_secret REVOLUT_PRO_VARIATION_ID || true)"
  REVOLUT_SCALE_VARIATION_ID="$(fetch_secret REVOLUT_SCALE_VARIATION_ID || true)"
...
SEASON_SETTLEMENT_ADMIN_KEY=$SEASON_SETTLEMENT_ADMIN_KEY
TELEGRAM_BOT_TOKEN=$TELEGRAM_BOT_TOKEN
ADMIN_SECRET=$ADMIN_SECRET
ADMIN_WALLETS=$ADMIN_WALLETS
ONSOCIAL_PORTAL_REWARDS_API_KEY=$ONSOCIAL_PORTAL_REWARDS_API_KEY
ONSOCIAL_PORTAL_REWARDS_APP_ID=$ONSOCIAL_PORTAL_REWARDS_APP_ID
ENVEOF

  {
    ...
    printf 'REVOLUT_PUBLIC_KEY=%s\n' "$REVOLUT_PUBLIC_KEY"
    printf 'REVOLUT_WEBHOOK_SIGNING_SECRET=%s\n' "$REVOLUT_WEBHOOK_SIGNING_SECRET"
    printf 'REVOLUT_PRO_VARIATION_ID=%s\n' "$REVOLUT_PRO_VARIATION_ID"
    printf 'REVOLUT_SCALE_VARIATION_ID=%s\n' "$REVOLUT_SCALE_VARIATION_ID"
    printf 'REVOLUT_API_URL=%s\n' "$REVOLUT_API_URL"
    printf 'REVOLUT_API_VERSION=%s\n' "$REVOLUT_API_VERSION"
    printf 'REVOLUT_SECRET_KEY_SANDBOX=%s\n' "$REVOLUT_SECRET_KEY_SANDBOX"
    printf 'REVOLUT_PUBLIC_KEY_SANDBOX=%s\n' "$REVOLUT_PUBLIC_KEY_SANDBOX"
    printf 'REVOLUT_WEBHOOK_SIGNING_SECRET_SANDBOX=%s\n' "$REVOLUT_WEBHOOK_SIGNING_SECRET_SANDBOX"
    printf 'REVOLUT_PRO_VARIATION_ID_SANDBOX=%s\n' "$REVOLUT_PRO_VARIATION_ID_SANDBOX"
    printf 'REVOLUT_SCALE_VARIATION_ID_SANDBOX=%s\n' "$REVOLUT_SCALE_VARIATION_ID_SANDBOX"
    printf 'REVOLUT_API_URL_SANDBOX=%s\n' "$REVOLUT_API_URL_SANDBOX"
    printf 'REVOLUT_API_VERSION_SANDBOX=%s\n' "$REVOLUT_API_VERSION_SANDBOX"
    printf 'REVOLUT_SECRET_KEY_PRODUCTION=%s\n' "$REVOLUT_SECRET_KEY_PRODUCTION"
    printf 'REVOLUT_PUBLIC_KEY_PRODUCTION=%s\n' "$REVOLUT_PUBLIC_KEY_PRODUCTION"
    printf 'REVOLUT_WEBHOOK_SIGNING_SECRET_PRODUCTION=%s\n' "$REVOLUT_WEBHOOK_SIGNING_SECRET_PRODUCTION"
    printf 'REVOLUT_PRO_VARIATION_ID_PRODUCTION=%s\n' "$REVOLUT_PRO_VARIATION_ID_PRODUCTION"
    printf 'REVOLUT_SCALE_VARIATION_ID_PRODUCTION=%s\n' "$REVOLUT_SCALE_VARIATION_ID_PRODUCTION"
    printf 'REVOLUT_API_URL_PRODUCTION=%s\n' "$REVOLUT_API_URL_PRODUCTION"
    printf 'REVOLUT_API_VERSION_PRODUCTION=%s\n' "$REVOLUT_API_VERSION_PRODUCTION"
  } >> .env.production
