...
ssh "${SSH_OPTIONS[@]}" "root@$SERVER_IP" bash -s \
  ...
  REWARDS_DELEGATE_PRIVATE_KEY="$(fetch_secret REWARDS_DELEGATE_PRIVATE_KEY)"
...
REWARDS_DELEGATE_ACCOUNT=relayer.$NEAR_SUFFIX
POSTGRES_USER=onsocial
POSTGRES_DB=onsocial_indexer
POSTGRES_PASSWORD=$POSTGRES_PASSWORD
HASURA_ADMIN_SECRET=$HASURA_ADMIN_SECRET
RELAYER_API_KEY=$RELAYER_API_KEY
REWARDS_DELEGATE_PRIVATE_KEY=$REWARDS_DELEGATE_PRIVATE_KEY
