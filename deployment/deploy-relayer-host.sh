...
grep -E '^(RELAYER_API_KEY|LAVA_API_KEY|NEARBLOCKS_API_KEY|GCP_KMS_PROJECT|GCP_KMS_LOCATION|GCP_KMS_ADMIN_KEY|RELAYER_DELEGATE_POOL_SIZE)=' "$RAW_ENV" > "$DEPLOY_ENV"
