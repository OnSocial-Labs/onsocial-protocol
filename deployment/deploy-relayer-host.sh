...
grep -E '^(RELAYER_API_KEY|LAVA_API_KEY|NEARBLOCKS_API_KEY|GCP_KMS_PROJECT|GCP_KMS_LOCATION|GCP_KMS_ADMIN_KEY|RELAYER_DELEGATE_POOL_SIZE|RELAYER_MIN_KEYS|RELAYER_MAX_KEYS|RELAYER_WARM_BUFFER|RELAYER_MAX_KEY_AGE)=' "$RAW_ENV" > "$DEPLOY_ENV"
