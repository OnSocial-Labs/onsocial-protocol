...
SECRETS=(
  ...
  "SEASON_SETTLEMENT_ADMIN_KEY:Backend-only admin key for Season settlement finalize/publish (min 32 chars)"
  "ONSOCIAL_PORTAL_REWARDS_API_KEY:Server-only Portal rewards partner API key"
  ...
  "REVOLUT_SECRET_KEY_SANDBOX:Revolut Merchant sandbox secret key"
  "REVOLUT_PUBLIC_KEY_SANDBOX:Revolut Merchant sandbox public key"
  "REVOLUT_WEBHOOK_SIGNING_SECRET_SANDBOX:Revolut sandbox webhook signing secret"
  "REVOLUT_SECRET_KEY_PRODUCTION:Revolut Merchant production secret key"
  "REVOLUT_PUBLIC_KEY_PRODUCTION:Revolut Merchant production public key"
  "REVOLUT_WEBHOOK_SIGNING_SECRET_PRODUCTION:Revolut production webhook signing secret"
  "REVOLUT_ENVIRONMENT:Revolut environment selector (sandbox or production)"
  ...
  "REVOLUT_PRO_VARIATION_ID_SANDBOX:Revolut Pro sandbox plan variation UUID"
  "REVOLUT_SCALE_VARIATION_ID_SANDBOX:Revolut Scale sandbox plan variation UUID"
  "REVOLUT_API_URL_SANDBOX:Optional Revolut sandbox API base URL override"
  "REVOLUT_API_VERSION_SANDBOX:Optional Revolut sandbox API version override"
  "REVOLUT_PRO_VARIATION_ID_PRODUCTION:Revolut Pro production plan variation UUID"
  "REVOLUT_SCALE_VARIATION_ID_PRODUCTION:Revolut Scale production plan variation UUID"
  "REVOLUT_API_URL_PRODUCTION:Optional Revolut production API base URL override"
  "REVOLUT_API_VERSION_PRODUCTION:Optional Revolut production API version override"
)
