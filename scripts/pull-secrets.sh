...
echo "RELAYER_DELEGATE_POOL_SIZE=${RELAYER_DELEGATE_POOL_SIZE:-$DEFAULT_DELEGATE_POOL_SIZE}"
echo "PUBLIC_DOMAIN=${PUBLIC_DOMAIN:-testnet.onsocial.id}"
echo "ONSOCIAL_PORTAL_REWARDS_APP_ID=${ONSOCIAL_PORTAL_REWARDS_APP_ID:-onsocial_portal}"
