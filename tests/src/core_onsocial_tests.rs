...
fn get_extra_number(event: &Event, key: &str) -> Option<String> {
    event.data.first().and_then(|d| d.extra.get(key)).map(|v| {
...
async fn test_get_config() -> anyhow::Result<()> {
    ...
    assert!(
        config.get("max_key_length").is_some(),
        "Should have max_key_length"
    );
    assert!(
        config.get("max_path_depth").is_some(),
        "Should have max_path_depth"
    );
    assert!(
        config.get("max_batch_size").is_some(),
        "Should have max_batch_size"
    );
...
async fn test_create_group() -> anyhow::Result<()> {
    ...
    let create_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "my_test_group", "config": {
                "is_private": false,
...
async fn test_group_membership() -> anyhow::Result<()> {
    ...
    let create_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "membership_test", "config": {
                "is_private": false
            } }
            }
        }))
    ...
    let add_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "membership_test", "member_id": bob.id() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let delegation_group_create = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "delegation_test", "config": {
                "is_private": true
            } }
            }
        }))
        ...
        .await?;
    assert!(
        delegation_group_create.is_success(),
        "Create delegation_test group should succeed"
    );
    ...
    let add_bob_member_only = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "delegation_test", "member_id": bob.id() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        add_bob_member_only.is_success(),
        "Owner should be able to add members (member-only)"
    );
    ...
    let grant_bob_join_requests_moderate = alice
        ...
        .await?;
    assert!(
        grant_bob_join_requests_moderate.is_success(),
        "Owner should be able to grant MODERATE on join_requests"
    );
    ...
    let charlie_join_request = charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "delegation_test" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        ...
        "Charlie should be able to submit a join request"
    );
    ...
    let bob_approves_charlie_member_only = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "approve_join_request", "group_id": "delegation_test", "requester_id": charlie.id() }
            }
        }))
        .deposit(ONE_NEAR)
...
async fn test_has_permission() -> anyhow::Result<()> {
    ...
    assert!(
        alice_has_perm,
        "Alice should have permission on her own path"
    );
    ...
    assert!(
        !bob_has_perm,
        "Bob should NOT have permission on Alice's path"
    );
...
async fn test_storage_balance() -> anyhow::Result<()> {
    ...
    assert!(
        after_balance.is_some(),
        "Should have storage balance after writing data"
    );
...
async fn test_event_partition_consistency_across_batch() -> anyhow::Result<()> {
    ...
    let partition_ids: Vec<u16> = events
        .iter()
    ...
    assert!(
        ...
        "Events should have partition_ids"
    );
    ...
    println!(
        "   ✅ All {} partition_ids are within valid range [0, {})",
        partition_ids.len(),
        NUM_PARTITIONS
    );
    ...
    println!(
        "   ✅ All {} events have consistent partition_id={}",
        partition_ids.len(),
        expected_partition
    );
...
async fn test_event_partition_for_group_paths() -> anyhow::Result<()> {
    ...
    let create_partition = create_event
        .data
        .first()
    ...
    if expected_group_partition != alice_partition {
        println!(
            "   ✅ Confirmed: group partition ({}) differs from user partition ({})",
...
async fn test_event_partition_fallback_to_account_id() -> anyhow::Result<()> {
    ...
    assert!(
        ...
        "Should emit storage_deposit event"
    );
    ...
    println!(
        "   Expected partition (from account_id): {}",
        expected_partition
    );
    ...
    assert!(
        !has_path,
        "storage_deposit event should NOT have a path field"
    );
...
async fn test_unauthorized_write_fails() -> anyhow::Result<()> {
    ...
    println!(
        "Bob's unauthorized write result: {:?}",
        bob_result.is_success()
    );
    ...
    if bob_result.is_success() {
        ...
        assert_eq!(
            name,
            Some("Alice"),
            "Alice's name should not have been changed"
        );
    }
...
async fn test_add_member_to_nonexistent_group_fails() -> anyhow::Result<()> {
    ...
    let add_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "nonexistent_group", "member_id": bob.id() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    println!(
        "Add to nonexistent group result: {:?}",
    ...
    assert!(
        !add_result.is_success(),
        "Adding member to nonexistent group should fail"
    );
...
async fn test_real_transaction_flow_social_platform() -> anyhow::Result<()> {
    ...
    println!(
        "   Alice balance:   {} NEAR",
        alice.view_account().await?.balance.as_near()
    );
    println!(
        "   Bob balance:     {} NEAR",
        bob.view_account().await?.balance.as_near()
    );
    println!(
        "   Charlie balance: {} NEAR",
        charlie.view_account().await?.balance.as_near()
    );
    ...
    println!(
        "   💰 NEAR spent (storage + gas): {} yoctoNEAR",
        storage_used
    );
    ...
    let group_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "rust_devs", "config": {
                "is_private": false,
    ...
    println!(
        "   ⛽ Gas used: {} TGas",
        group_result.total_gas_burnt.as_tgas()
    );
    ...
    let add_bob_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "rust_devs", "member_id": bob.id() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    println!(
        "   📊 Bob's permission flags: {}",
        member_data.get("level").unwrap()
    );
    ...
    println!(
        "   ⛽ Gas used: {} TGas",
        post_result.total_gas_burnt.as_tgas()
    );
    println!(
        "   💰 Bob's NEAR change: {} yoctoNEAR",
    ...
    if let Some(stats) = group_stats {
        println!(
            "   Total members: {}",
            stats.get("total_members").unwrap_or(&json!(0))
        );
    }
    ...
    let unauthorized_result = charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "rust_devs", "member_id": "random.near" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !unauthorized_result.is_success(),
        "Unauthorized action should fail"
    );
...
async fn test_batch_operations_multiple_keys() -> anyhow::Result<()> {
    ...
    assert!(
        !event_logs.is_empty(),
        "Should emit events for batch operations"
    );
    ...
    if let Some(first_event_log) = event_logs.first() {
        ...
        if let Some(event) = decode_event(first_event_log) {
            ...
            println!(
                "      - operation: {}",
                get_event_operation(&event).unwrap_or("none")
            );
            if let Some(data) = event.data.first() {
                ...
                println!(
                    ...
                    expected_partition, data.partition_id
                );
                ...
                assert_eq!(
                    ...
                    "Partition ID should match expected"
                );

                println!(
                    "   ✅ Partition verified: partition_id={}",
                    expected_partition
                );
            }
        } else {
    ...
    println!(
        "   ⛽ Gas used: {} TGas",
        batch_result.total_gas_burnt.as_tgas()
    );
    println!(
        "   💾 Storage used: {} bytes (~{:.4} NEAR)",
        bytes_used, storage_near
    );
    ...
    assert!(
        large_batch_result.is_success(),
        "Programmatic batch should succeed"
    );
    ...
    assert!(
        event_logs_2.len() >= 10,
        "Should emit at least 10 events for 10 keys"
    );
    ...
    println!(
        "   ⛽ Gas used: {} TGas",
        large_batch_result.total_gas_burnt.as_tgas()
    );
    println!(
        "   💾 Storage: +{} bytes (total: {} bytes, ~{:.4} NEAR)",
        bytes_for_batch, bytes_used_2, storage_near_2
    );
    ...
    let delete_events: Vec<_> = delete_logs
        .iter()
        .filter(|log| log.starts_with("EVENT_JSON:"))
        .collect();
    ...
    let name_entry = deleted_check
        ...
        .expect("Should have EntryView for name");
    assert_eq!(
        name_entry.get("deleted").and_then(|v| v.as_bool()),
        Some(false)
    );
    assert!(
        name_entry
    ...
    assert_eq!(
        twitter_entry.get("deleted").and_then(|v| v.as_bool()),
        Some(true)
    );
    assert_eq!(
    ...
    assert!(
        path_str.contains("test/extra_check"),
        "Path should contain the key"
    );
    ...
    assert!(
        deposit_test_result.is_success(),
        "Deposit test should succeed"
    );
    ...
    println!(
        "   💰 Storage balance before: {} yocto",
        balance_before_deposit
    );
    println!(
        "   💰 Storage balance after: {} yocto",
        balance_after_deposit
    );
    println!(
        "   💰 Storage balance increased by: ~{:.4} NEAR",
        deposit_added_near
    );
    ...
    println!(
        "   📊 Balance before: {} yocto, after: {} yocto",
        balance_before_storage, balance_after_storage
    );
    println!(
        "   📊 Balance delta: +{} yoctoNEAR (~{:.4} NEAR)",
        balance_delta,
        balance_delta as f64 / 1e24
    );
    ...
    println!(
        "   📊 Expected balance for {} bytes: {} yoctoNEAR",
        bytes_delta, expected_balance_for_bytes
    );
    ...
    println!(
        "   📊 Current storage balance: {} yocto (~{:.4} NEAR)",
        balance_before_withdraw,
        balance_before_withdraw as f64 / 1e24
    );
    println!(
        "   📊 Bytes used: {} (locks {} yocto, ~{:.4} NEAR)",
        bytes_used,
        locked_balance,
        locked_balance as f64 / 1e24
    );
    println!(
        "   📊 Available to withdraw: {} yocto (~{:.4} NEAR)",
        available_to_withdraw,
        available_to_withdraw as f64 / 1e24
    );
    ...
    if withdraw_result.is_success() {
        ...
        let alice_balance_after = alice.view_account().await?.balance;
        let balance_increase = alice_balance_after
            .as_yoctonear()
            .saturating_sub(alice_balance_before.as_yoctonear());
        ...
        println!(
            "   💰 Storage balance decreased by: {} yocto (~{:.4} NEAR)",
            storage_decrease,
            storage_decrease as f64 / 1e24
        );
        println!(
            "   💰 Alice received: ~{:.4} NEAR (minus gas)",
            balance_increase as f64 / 1e24
        );

        // Verify storage balance decreased
        assert!(
            storage_decrease > 0,
            "Storage balance should decrease after withdrawal"
        );
    ...
    let grant_events: Vec<_> = grant_logs
        .iter()
        .filter(|log| log.starts_with("EVENT_JSON:"))
        .collect();
    ...
    assert!(
        delegated_write_result.is_success(),
        "Delegated write should succeed"
    );
    ...
    println!(
        "   ✓ Storage reclaimed on delete: {} bytes freed",
        bytes_reclaimed
    );
    ...
    assert!(
        !unauthorized_result.is_success(),
        "Unauthorized write should fail"
    );
    ...
    assert!(
        !post_revoke_write.is_success(),
        "Write after revoke should fail"
    );
    ...
    if wildcard_write.is_success() {
        ...
        assert!(
            wildcard_data.len() == 3,
            "All 3 wildcard writes should succeed"
        );
    ...
    assert!(
        cross_shard_result.is_success(),
        "Cross-shard write should succeed"
    );

    // Check events for different partitions
    let cross_shard_events: Vec<_> = cross_shard_result
        .logs()
        .iter()
        .filter(|log| log.starts_with("EVENT_JSON:"))
        .filter_map(|log| decode_event(log))
    ...
    println!(
        "   📣 Events: {} total, {} unique partitions",
        cross_shard_events.len(),
    ...
    let large_array: Vec<String> = (0..100)
        .map(|i| format!("Item number {} with some extra text to make it longer", i))
        .collect();
    let large_json = json!({
        "metadata": {
            "version": "1.0",
    ...
    assert!(
        large_value_result.is_success(),
        "Large value storage should succeed"
    );
    ...
    println!(
        "   ✓ Large value stored and retrieved ({} items)",
        items.len()
    );
    ...
    let group_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "test-community", "config": {
                "is_public": true,
    ...
    assert!(
        verify_event_base(create_event, "onsocial", "1.0.0"),
        "Event should have correct standard and version"
    );
    assert_eq!(
        create_event.event, "GROUP_UPDATE",
        "Event type should be GROUP_UPDATE"
    );
    assert!(
        event_has_operation(create_event, "create_group"),
        "Operation type should be create_group"
    );

    // Verify author is alice (the creator)
    assert!(
        verify_event_author(create_event, alice.id().as_str()),
        "Event author should be alice"
    );

    // Verify event path contains group config
    assert!(
        verify_event_path_contains(create_event, "groups/test-community/config"),
    ...
    assert!(
        value_json.get("owner").is_some(),
        "Event value should contain owner"
    );
    assert!(
        value_json.get("is_private").is_some(),
        "Event value should contain is_private"
    );
    ...
    let join_result = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": group_id }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        ...
        "Join should succeed for public group"
    );
    ...
    assert!(
        !add_member_events.is_empty(),
        "Should emit add_member event on join"
    );
    let add_event = &add_member_events[0];

    assert!(
        verify_event_base(add_event, "onsocial", "1.0.0"),
        "add_member event should have correct standard/version"
    );
    assert!(
        verify_event_author(add_event, bob.id().as_str()),
        "add_member author should be the new member (bob)"
    );
    assert!(
        verify_event_path_contains(
            add_event,
            &format!("groups/{}/members/{}", group_id, bob.id())
        ),
    ...
    assert!(
        member_json.get("level").is_some(),
        "Member data should have level"
    );

    // VERIFY PARTITION for add_member event
    let add_data = add_event
        .data
        .first()
        .expect("add_member event should have data");
    assert!(
        add_data.partition_id.is_some(),
        "add_member event should have partition_id"
    );

    // Verify partition for member path: groups/{group_id/members/{member_id}
    let _member_relative_path = format!("members/{}", bob.id());
    assert!(
        verify_event_partition(add_event, group_id),
    ...
    let leave_result = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "leave_group", "group_id": group_id }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    assert!(
        !remove_member_events.is_empty(),
        "Should emit remove_member event on leave"
    );
    let remove_event = &remove_member_events[0];

    assert!(
        verify_event_base(remove_event, "onsocial", "1.0.0"),
        "remove_member event should have correct standard/version"
    );
    assert!(
        verify_event_author(remove_event, bob.id().as_str()),
    ...
    assert!(
        remove_value.is_none() || remove_value == Some(serde_json::Value::Null),
        "remove_member value should be null for deletion"
    );

    // Check flattened metadata fields
    let removed_by = remove_event
        .data
        .first()
    ...
    assert!(
        removed_by.is_some(),
        "Remove event should have removed_by field"
    );

    let is_self_removal = remove_event
        .data
        .first()
    ...
    let from_governance = remove_event
        .data
        .first()
    ...
    let remove_data = remove_event
        .data
        .first()
        .expect("remove_member event should have data");
    assert!(
        remove_data.partition_id.is_some(),
        "remove_member event should have partition_id"
    );
    let _remove_member_path = format!("members/{}", bob.id());
    assert!(
        verify_event_partition(remove_event, group_id),
    ...
    let status_before: serde_json::Value = contract.view("get_contract_status").await?.json()?;
    ...
    let write_before_pause = alice
        ...
        .await?;
    assert!(
        write_before_pause.is_success(),
        "Write should work before pause"
    );
    ...
    let status: serde_json::Value = contract.view("get_contract_status").await?.json()?;
    ...
    let private_group_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "private-club", "config": {
                "is_private": true,
    ...
    assert!(
        private_group_result.is_success(),
        "Private group creation should succeed"
    );
    ...
    if !is_owner_member {
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "private-club", "member_id": alice.id().to_string() }
            }
        }))
            .deposit(ONE_NEAR)
            .gas(near_workspaces::types::Gas::from_tgas(100))
            ...
            .await?;
        assert!(
            add_owner_member.is_success(),
            "Owner should be addable as a member for test setup"
        );
    }
    ...
    let owner_leave_attempt = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "leave_group", "group_id": "private-club" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
        .await?;
    assert!(
        !owner_leave_attempt.is_success(),
    ...
    let is_owner_still_member: bool = contract
        ...
        .json()?;
    assert!(
        is_owner_still_member,
        "Owner must remain a member after failed leave"
    );
    ...
    let join_nonexistent = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "nonexistent-group-xyz" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !join_nonexistent.is_success(),
        "Join request to non-existent group should fail"
    );
    ...
    let join_request_result = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "private-club" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if !join_request_result.is_success() {
        println!(
            "   ⚠ Join request failed: {:?}",
            join_request_result.failures()
        );
    }
    assert!(
        join_request_result.is_success(),
        "Join request should succeed"
    );
    ...
    assert!(
        !is_member_pending,
        "Bob should NOT be a member yet (pending)"
    );
    ...
    let approve_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "approve_join_request", "group_id": "private-club", "requester_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        is_member_after_approve,
        "Bob should be a member after approval"
    );
    ...
    assert!(
        carol_join.is_success(),
        "Carol's join request should succeed"
    );
    ...
    let join_requests_after_submit = stats_after_request
        ...
        .unwrap_or(0);
    assert_eq!(
        join_requests_after_submit,
        initial_join_requests + 1,
        "Join request count should increment on request"
    );
    println!(
        "   ✓ JOIN REQUEST COUNT INCREMENTED: {} -> {}",
        initial_join_requests, join_requests_after_submit
    );
    ...
    let reject_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "reject_join_request", "group_id": "private-club", "requester_id": carol.id().to_string(), "reason": null }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    assert!(
        verify_event_base(reject_event, "onsocial", "1.0.0"),
        "join_request_rejected event should have correct standard/version"
    );
    assert!(
        verify_event_author(reject_event, alice.id().as_str()),
        "join_request_rejected author should be the executor (alice)"
    );
    assert!(
        verify_event_path_contains(
            reject_event,
            &format!("groups/private-club/join_requests/{}", carol.id())
        ),
    ...
    assert!(
        reject_json.is_some(),
        "join_request_rejected should have value field"
    );
    let reject_json = reject_json.unwrap();
    assert_eq!(
        reject_json.get("status").and_then(|v| v.as_str()),
        Some("rejected"),
        "Reject status should be 'rejected'"
    );
    assert!(
        reject_json.get("rejected_by").is_some(),
        "Reject data should have rejected_by"
    );
    assert!(
        reject_json.get("rejected_at").is_some(),
        "Reject data should have rejected_at"
    );
    ...
    let join_requests_after_reject = stats_after_reject
        ...
        .unwrap_or(0);
    assert_eq!(
        join_requests_after_reject, initial_join_requests,
        "Join request count should decrement on reject"
    );
    println!(
        "   ✓ JOIN REQUEST COUNT DECREMENTED ON REJECT: {} -> {}",
        join_requests_after_submit, join_requests_after_reject
    );
    ...
    assert!(
        !is_carol_member,
        "Carol should not be a member after rejection"
    );
    ...
    let blacklist_gary = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "private-club", "member_id": gary.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        blacklist_gary.is_success(),
        "Blacklisting Gary should succeed"
    );
    ...
    let gary_join_private = gary
        ...
        .await?;
    assert!(
        !gary_join_private.is_success(),
        "Blacklisted user should not be able to request to join private group"
    );
    ...
    let blacklist_frank = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "test-community", "member_id": frank.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        blacklist_frank.is_success(),
        "Blacklisting Frank should succeed"
    );
    ...
    let frank_join_public = frank
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "test-community" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        !frank_join_public.is_success(),
        "Blacklisted user should not be able to join public group"
    );
    ...
    let reject_with_reason = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "reject_join_request", "group_id": "private-club", "requester_id": carol.id().to_string(), "reason": "Not a good fit for this group" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let join_requests_after_reject_with_reason = stats_after_reject_with_reason
        ...
        .unwrap_or(0);
    assert_eq!(
        join_requests_after_reject_with_reason, initial_join_requests,
        "Join request count should decrement on reject with reason"
    );
    println!(
        "   ✓ JOIN REQUEST COUNT DECREMENTED ON REJECT WITH REASON: {} -> {}",
        join_requests_before_reject_with_reason, join_requests_after_reject_with_reason
    );
    ...
    if let Some(req) = rejected_request {
        ...
        assert_eq!(
            reason,
            Some("Not a good fit for this group"),
    ...
    let helen_request = helen
        ...
        .await?;
    assert!(
        helen_request.is_success(),
        "Helen's join request should succeed"
    );
    ...
    let blacklist_helen = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "private-club", "member_id": helen.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        blacklist_helen.is_success(),
        "Blacklisting Helen should succeed"
    );
    ...
    let approve_blacklisted_requester = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "approve_join_request", "group_id": "private-club", "requester_id": helen.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let count_after_failed_approve_blacklisted = stats_after_failed_approve_blacklisted
        ...
        .unwrap_or(0);
    assert_eq!(
        count_after_failed_approve_blacklisted, count_after_helen_request,
    ...
    let approve_after_reject = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "approve_join_request", "group_id": "private-club", "requester_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let reject_after_reject = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "reject_join_request", "group_id": "private-club", "requester_id": carol.id().to_string(), "reason": "double-reject should fail" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let cancel_after_reject = carol
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "cancel_join_request", "group_id": "private-club" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let join_requests_after_invalid_reject_transitions = stats_after_invalid_reject_transitions
        ...
        .unwrap_or(0);
    assert_eq!(
        join_requests_after_invalid_reject_transitions, count_after_failed_approve_blacklisted,
    ...
    assert!(
        dan_request.is_success(),
        "Dan's join request should succeed"
    );
    ...
    let count_after_dan_request = stats_after_dan_request
        ...
        .unwrap_or(0);
    assert_eq!(
        count_after_dan_request,
        count_before_dan + 1,
        "Count should increment for Dan's request"
    );
    println!(
        "   ✓ JOIN REQUEST COUNT: {} (Dan's request added)",
        count_after_dan_request
    );
    ...
    let approve_higher = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "approve_join_request", "group_id": "private-club", "requester_id": dan.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let count_after_approve = stats_after_approve
        ...
        .unwrap_or(0);
    assert_eq!(
        count_after_approve, count_before_dan,
        "Count should decrement on approve"
    );
    println!(
        "   ✓ JOIN REQUEST COUNT DECREMENTED ON APPROVE: {} -> {}",
        count_after_dan_request, count_after_approve
    );
    ...
    if let Some(req) = dan_request {
        ...
        assert_eq!(
            granted,
            Some(0),
            "Join request should show granted_permissions=0"
        );
    ...
    let add_mod1 = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "private-club", "member_id": mod1.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let grant_mod1_join_requests = alice
        ...
        .await?;
    assert!(
        grant_mod1_join_requests.is_success(),
        "Granting mod1 MODERATE on join_requests should succeed"
    );
    ...
    let ivan_request = ivan
        ...
        .await?;
    assert!(
        ivan_request.is_success(),
        "Ivan's join request should succeed"
    );
    ...
    assert_eq!(
        ...
        count_before_ivan + 1,
        "Count should increment for Ivan's request"
    );
    ...
    let owner_approve_manage = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "approve_join_request", "group_id": "private-club", "requester_id": ivan.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        owner_approve_manage.is_success(),
    ...
    let count_after_owner_manage = stats_after_owner_manage
        ...
        .unwrap_or(0);
    assert_eq!(
        count_after_owner_manage, count_before_ivan,
    ...
    let remove_ivan_for_upgrade = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "remove_group_member", "group_id": "private-club", "member_id": ivan.id().to_string() }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
        .await?;
    assert!(
        remove_ivan_for_upgrade.is_success(),
        "Removing Ivan for upgrade should succeed"
    );
    ...
    let readd_ivan_as_manage = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "private-club", "member_id": ivan.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        readd_ivan_as_manage.is_success(),
        "Re-adding Ivan with MANAGE should succeed"
    );
    ...
    let remove_owner_attempt = ivan
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "remove_group_member", "group_id": "private-club", "member_id": alice.id().to_string() }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let reject_after_approve = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "reject_join_request", "group_id": "private-club", "requester_id": dan.id().to_string(), "reason": "cannot reject after approve" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let join_requests_after_invalid_approve_transitions = stats_after_invalid_approve_transitions
        ...
        .unwrap_or(0);
    assert_eq!(
        join_requests_after_invalid_approve_transitions, count_before_dan,
    ...
    let add_carol = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "private-club", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let blacklist_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "private-club", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !blacklist_events.is_empty(),
        "Should emit add_to_blacklist event"
    );
    let bl_event = &blacklist_events[0];

    assert!(
        verify_event_base(bl_event, "onsocial", "1.0.0"),
        "add_to_blacklist event should have correct standard/version"
    );
    assert!(
        verify_event_author(bl_event, alice.id().as_str()),
        "add_to_blacklist author should be the adder (alice)"
    );
    assert!(
        verify_event_path_contains(
            bl_event,
            &format!("groups/private-club/blacklist/{}", carol.id())
        ),
    ...
    assert!(
        bl_json.is_some(),
        "add_to_blacklist should have value field"
    );
    let bl_json = bl_json.unwrap();
    assert_eq!(
        bl_json.get("blacklisted").and_then(|v| v.as_bool()),
        Some(true),
        "blacklisted should be true"
    );
    assert!(
        bl_json.get("added_by").is_some(),
        "Blacklist data should have added_by"
    );
    assert!(
        bl_json.get("added_at").is_some(),
        "Blacklist data should have added_at"
    );
    assert_eq!(
        bl_json.get("from_governance").and_then(|v| v.as_bool()),
        Some(false),
        "from_governance should be false for direct blacklist"
    );

    // VERIFY PARTITION for add_to_blacklist event
    let bl_data = bl_event
        .data
        .first()
        .expect("add_to_blacklist event should have data");
    assert!(
        bl_data.partition_id.is_some(),
        "add_to_blacklist event should have partition_id"
    );
    let _blacklist_relative_path = format!("blacklist/{}", carol.id());
    assert!(
        verify_event_partition(bl_event, "private-club"),
    ...
    assert!(
        ...
        "Blacklist should also emit remove_member event"
    );
    ...
    assert!(
        !is_carol_still_member,
        "Carol should not be a member after blacklist"
    );
    ...
    assert!(
        !carol_rejoin.is_success(),
        "Blacklisted user should not be able to rejoin"
    );
    ...
    let blacklist_from_public = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "test-community", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        blacklist_from_public.is_success(),
        "Blacklisting from public group should succeed"
    );
    ...
    assert!(
        !carol_self_join_public.is_success(),
        "Blacklisted user cannot self-join public group"
    );
    ...
    let unblacklist_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "unblacklist_group_member", "group_id": "private-club", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if !unblacklist_result.is_success() {
        println!(
            "   ⚠ Unblacklist failed: {:?}",
            unblacklist_result.failures()
        );
    }
    assert!(
        unblacklist_result.is_success(),
        "Unblacklist should succeed"
    );
    ...
    assert!(
        !unbl_events.is_empty(),
        "Should emit remove_from_blacklist event"
    );
    let unbl_event = &unbl_events[0];

    assert!(
        verify_event_base(unbl_event, "onsocial", "1.0.0"),
        "remove_from_blacklist event should have correct standard/version"
    );
    assert!(
        verify_event_author(unbl_event, alice.id().as_str()),
    ...
    assert!(
        unbl_value.is_none() || unbl_value == Some(serde_json::Value::Null),
        "remove_from_blacklist value should be null for deletion"
    );

    // Check flattened metadata fields
    let unbl_data_extra = &unbl_event
        .data
        .first()
        .expect("event should have data")
        .extra;
    assert_eq!(
        unbl_data_extra.get("blacklisted").and_then(|v| v.as_bool()),
        Some(false),
        "blacklisted should be false"
    );
    assert!(
        unbl_data_extra.get("removed_by").is_some(),
        "Unblacklist data should have removed_by"
    );
    assert!(
        unbl_data_extra.get("removed_at").is_some(),
        "Unblacklist data should have removed_at"
    );
    assert_eq!(
        unbl_data_extra
            .get("from_governance")
    ...
    let unbl_data = unbl_event
        .data
        .first()
        .expect("remove_from_blacklist event should have data");
    assert!(
        unbl_data.partition_id.is_some(),
        "remove_from_blacklist event should have partition_id"
    );
    let _unbl_relative_path = format!("blacklist/{}", carol.id());
    assert!(
        verify_event_partition(unbl_event, "private-club"),
    ...
    assert!(
        ...
        "Carol should not be blacklisted anymore"
    );
    ...
    assert!(
        unblacklist_again.is_success(),
        "Idempotent unblacklist should succeed"
    );
    ...
    let unblacklist_never_blacklisted = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "unblacklist_group_member", "group_id": "private-club", "member_id": yuki.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !yuki_blacklisted,
        "Never-blacklisted user must remain not blacklisted"
    );
    ...
    assert!(
        readd_carol.is_success(),
        "Should be able to re-add Carol after unblacklisting"
    );
    ...
    assert!(
        carol_leave.is_success(),
        "Carol should be able to leave group"
    );
    ...
    if !carol_resubmit.is_success() {
        println!(
            "   ⚠ Carol resubmit failed: {:?}",
            carol_resubmit.failures()
        );
    }
    assert!(
        carol_resubmit.is_success(),
        "Carol should be able to resubmit after rejection (bug fix)"
    );
    ...
    let add_david = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "private-club", "member_id": david.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let blacklist_david = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "private-club", "member_id": david.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        blacklist_david.is_success(),
        "Blacklisting David should succeed"
    );
    ...
    assert!(
        !readd_blacklisted_david.is_success(),
        "Should NOT be able to re-add blacklisted user without unblacklisting first"
    );
    ...
    let remove_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "remove_group_member", "group_id": "private-club", "member_id": bob.id().to_string() }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    assert!(
        verify_event_author(remove_event, alice.id().as_str()),
        "remove_member author should be the remover (alice)"
    );
    assert!(
        verify_event_path_contains(
            remove_event,
            &format!("groups/private-club/members/{}", bob.id())
        ),
        "remove_member path should contain member path"
    );
    ...
    // Check flattened metadata fields
    let remove_data_extra = &remove_event
        .data
        .first()
        .expect("event should have data")
        .extra;
    assert!(
        remove_data_extra.get("removed_by").is_some(),
        "Remove data should have removed_by"
    );
    assert!(
        remove_data_extra.get("removed_at").is_some(),
        "Remove data should have removed_at"
    );
    assert_eq!(
        remove_data_extra
            .get("is_self_removal")
    ...
    assert!(
        verify_event_partition(remove_event, "private-club"),
        "remove_member event partition should match expected value"
    );
    ...
    let readd_bob_after_removal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "private-club", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        readd_bob_after_removal.is_success(),
        "Re-adding soft-deleted member should succeed"
    );
    ...
    assert!(
        is_bob_member_again,
        "Bob should be a member again after re-adding"
    );
    ...
    let remove_bob_again = alice
        ...
        .await?;
    assert!(
        remove_bob_again.is_success(),
        "Remove Bob again should succeed"
    );
    ...
    let transfer_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "transfer_group_ownership", "group_id": "private-club", "new_owner": bob.id().to_string(), "remove_old_owner": null }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        ...
        "Ownership transfer should succeed"
    );
    ...
    assert!(
        verify_event_base(xfer_event, "onsocial", "1.0.0"),
        "transfer_ownership event should have correct standard/version"
    );
    assert!(
        verify_event_author(xfer_event, alice.id().as_str()),
    ...
    assert_eq!(
        new_owner_val.as_deref(),
        Some(bob.id().as_str()),
        "Event should have correct new_owner"
    );

    let prev_owner_val = get_extra_string(xfer_event, "previous_owner");
    assert_eq!(
        prev_owner_val.as_deref(),
        Some(alice.id().as_str()),
        "Event should have correct previous_owner"
    );

    let transferred_at = get_extra_number(xfer_event, "transferred_at");
    assert!(
        transferred_at.is_some(),
        "Event should have transferred_at timestamp"
    );
    ...
    let unauthorized_transfer = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "transfer_group_ownership", "group_id": "private-club", "new_owner": alice.id().to_string(), "remove_old_owner": null }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !unauthorized_transfer.is_success(),
    ...
    let non_member_transfer = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "transfer_group_ownership", "group_id": "private-club", "new_owner": carol.id().to_string(), "remove_old_owner": null }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !non_member_transfer.is_success(),
    ...
    let transfer_keep_old = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "transfer_group_ownership", "group_id": "private-club", "new_owner": alice.id().to_string(), "remove_old_owner": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        transfer_keep_old.is_success(),
        "Transfer with remove_old_owner=false should succeed"
    );
    ...
    let nonexistent_transfer = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "transfer_group_ownership", "group_id": "nonexistent-group-xyz", "new_owner": bob.id().to_string(), "remove_old_owner": null }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !nonexistent_transfer.is_success(),
        "Transfer in non-existent group should fail"
    );
    ...
    let privacy_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "set_group_privacy", "group_id": "private-club", "is_private": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if !privacy_result.is_success() {
        println!(
            "   ⚠ Privacy change failed: {:?}",
            privacy_result.failures()
        );
    }
    ...
    println!(
        "   📊 Bob's permissions on alice/delegated: {}",
        permissions
    );
    ...
    let add_member_only = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "test-community", "member_id": david.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        grant_david_manage.is_success(),
        "Owner can grant path-based MANAGE via set_permission"
    );
    ...
    let create_md_group = iris
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "democracy-group", "config": {
                "member_driven": true,
                "is_private": true
            } }
            }
    ...
    assert!(
        ...
        "Member-driven group creation should succeed"
    );
    ...
    let add_kate = iris
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "democracy-group", "member_id": kate.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        add_kate.is_success(),
        "Adding Kate should auto-execute (single member)"
    );
    ...
    let direct_add_md = iris
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "democracy-group", "member_id": jack.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        direct_add_md.is_success(),
        "Member-driven groups should create proposal for member addition"
    );
    ...
    assert!(
        !is_jack_member,
        "Jack should not be a member yet (pending proposal)"
    );
    ...
    let owner_leave = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "leave_group", "group_id": "test-community" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let create_prot_group = owner_prot
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "owner-protect-group", "config": {
                "member_driven": false,
                "is_private": false,
    ...
    let add_manager = owner_prot
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "owner-protect-group", "member_id": manager_user.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let grant_manager_manage = owner_prot
        ...
        .await?;
    assert!(
        grant_manager_manage.is_success(),
        "Granting MANAGE via set_permission should succeed"
    );
    ...
    let add_regular = owner_prot
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "owner-protect-group", "member_id": regular_user.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        add_regular.is_success(),
        "Adding regular user should succeed"
    );
    ...
    let blacklist_owner_attempt = manager_user
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "owner-protect-group", "member_id": owner_prot.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !blacklist_owner_attempt.is_success(),
        "Manager should not be able to blacklist owner"
    );
    ...
    let remove_owner_attempt = manager_user
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "remove_group_member", "group_id": "owner-protect-group", "member_id": owner_prot.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        is_manager_member,
        "Manager should be a member before removal"
    );
    ...
    let owner_remove_manager = owner_prot
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "remove_group_member", "group_id": "owner-protect-group", "member_id": manager_user.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        owner_remove_manager.is_success(),
        "Owner should be able to remove manager"
    );
    ...
    let owner_remove_regular = owner_prot
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "remove_group_member", "group_id": "owner-protect-group", "member_id": regular_user.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        owner_remove_regular.is_success(),
        "Owner should be able to remove regular user"
    );
    ...
    let create_member_driven = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "dao-group", "config": {
                "member_driven": true,
                "is_private": true,
    ...
    assert!(
        create_member_driven.is_success(),
        "Member-driven group creation should succeed"
    );
    ...
    let add_bob_to_dao = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "dao-group", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        add_bob_to_dao.is_success(),
        "Adding Bob to dao-group should succeed"
    );
    ...
    let add_carol_to_dao = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "dao-group", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        add_carol_to_dao.is_success(),
        "Adding Carol to dao-group should succeed"
    );
    ...
    let create_proposal = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "dao-group", "proposal_type": "member_invite", "changes": {
    ...
    let vote_yes = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "dao-group", "proposal_id": proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        is_eve_member,
        "Eve should be a member after proposal execution"
    );
    ...
    assert!(
        bob_member_data_before.is_some(),
        "Bob should have member data"
    );
    ...
    let permission_change_proposal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "dao-group", "proposal_type": "permission_change", "changes": {
    ...
    assert!(
        permission_change_proposal.is_success(),
        "Creating permission change proposal should succeed: {:?}",
        permission_change_proposal.outcome()
    );
    let perm_proposal_id: String = permission_change_proposal.json()?;
    println!(
        "   ✓ Created permission change proposal: {}",
        perm_proposal_id
    );
    ...
    let bob_votes_yes = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "dao-group", "proposal_id": perm_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        bob_votes_yes.is_success(),
        "Bob voting YES should succeed: {:?}",
        bob_votes_yes.outcome()
    );
    ...
    assert!(
        bob_member_data_after.is_some(),
        "Bob should still have member data after permission change"
    );
    let bob_data_after = bob_member_data_after.unwrap();

    // CRITICAL: Verify permission flags were updated
    let new_level = bob_data_after
        .get("level")
        .and_then(|v| v.as_u64())
        .expect("level should exist");
    assert_eq!(
        new_level, 3,
        "Bob's permissions should be updated to 3 (MANAGE)"
    );
    ...
    assert_eq!(
        bob_joined_at, bob_joined_at_after,
    ...
    assert!(
        ...
        "Creating second proposal should succeed"
    );
    ...
    let vote_no = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "dao-group", "proposal_id": proposal_id2.clone(), "approve": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        !is_leo_member,
        "Leo should NOT be a member - proposal was rejected"
    );
    ...
    let create_custom = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "dao-group", "proposal_type": "custom_proposal", "changes": {
    ...
    assert!(
        create_custom.is_success(),
        "Creating custom proposal should succeed"
    );
    ...
    let double_vote = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "dao-group", "proposal_id": custom_proposal_id.clone(), "approve": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        !non_member_proposal.is_success(),
        "Non-member proposal should fail"
    );
    ...
    let non_member_vote = leo
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "dao-group", "proposal_id": custom_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let create_md_restrict = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "md-restrict-group", "config": {
                "member_driven": true,
                "is_private": true,
    ...
    let add_nina = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "md-restrict-group", "member_id": nina.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let oscar_join = oscar
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "md-restrict-group" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let approve_attempt = nina
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "approve_join_request", "group_id": "md-restrict-group", "requester_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !approve_attempt.is_success(),
        "approve_join_request should fail in member-driven group"
    );
    ...
    let is_oscar_member_after_approve: bool = contract
        ...
        .json()?;
    assert!(
        !is_oscar_member_after_approve,
        "Oscar should not be member after blocked approve"
    );
    ...
    let reject_attempt = nina
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "reject_join_request", "group_id": "md-restrict-group", "requester_id": oscar.id().to_string(), "reason": null }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        !reject_attempt.is_success(),
        "reject_join_request should fail in member-driven group"
    );
    ...
    let oscar_invite_proposal = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "md-restrict-group", "proposal_type": "member_invite", "changes": {
    ...
    assert!(
        oscar_invite_proposal.is_success(),
        "Creating member invite proposal should succeed"
    );
    let proposal_id: String = oscar_invite_proposal.json()?;
    println!(
        "      ✓ Created member invite proposal for Oscar: {}",
        proposal_id
    );
    ...
    let vote_add_oscar = nina
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "md-restrict-group", "proposal_id": proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let is_oscar_member_final: bool = contract
        ...
        .json()?;
    assert!(
        is_oscar_member_final,
        "Oscar should be member after proposal execution"
    );
    ...
    let blacklist_attempt = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "md-restrict-group", "member_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        ...
        "blacklist_group_member should create ban proposal in member-driven group"
    );
    println!("      ✓ blacklist_group_member created ban proposal (not direct blacklist)");

    // Extract ban proposal ID from event logs
    let ban_proposal_id =
        extract_proposal_id_from_logs(&blacklist_attempt.logs(), "proposal_created")
    ...
    let is_oscar_blacklisted: bool = contract
        ...
        .json()?;
    assert!(
        !is_oscar_blacklisted,
        "Oscar should not be blacklisted - direct blacklist blocked"
    );
    ...
    let vote_ban_oscar = nina
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "md-restrict-group", "proposal_id": ban_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        vote_ban_oscar.is_success(),
        "Vote on ban proposal should succeed"
    );
    ...
    let is_oscar_member_after_ban: bool = contract
        ...
        .json()?;
    assert!(
        !is_oscar_member_after_ban,
        "Oscar should be removed from group after ban proposal execution"
    );
    ...
    let unban_oscar = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "unblacklist_group_member", "group_id": "md-restrict-group", "member_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let vote_unban = nina
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "md-restrict-group", "proposal_id": unban_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let readd_oscar = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "md-restrict-group", "member_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let vote_readd = nina
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "md-restrict-group", "proposal_id": readd_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let create_trad = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "trad-group", "config": {
                "member_driven": false,
                "is_private": false
            } }
            }
    ...
    assert!(
        create_trad.is_success(),
        "Traditional group creation should succeed"
    );
    ...
    let add_oscar_trad = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "trad-group", "member_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if !add_oscar_trad.is_success() {
        println!(
            "      ⚠ Failed to add Oscar to traditional group: {:?}",
            add_oscar_trad.failures()
        );
    }
    assert!(
        add_oscar_trad.is_success(),
        "Should add Oscar to traditional group"
    );
    ...
    let blacklist_trad = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "trad-group", "member_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if !blacklist_trad.is_success() {
        println!(
            "      ⚠ Failed to blacklist Oscar in traditional group: {:?}",
            blacklist_trad.failures()
        );
    }
    assert!(
        blacklist_trad.is_success(),
        "Traditional group blacklist should work directly"
    );
    ...
    let is_oscar_blacklisted_trad: bool = contract
        ...
        .json()?;
    assert!(
        is_oscar_blacklisted_trad,
        "Oscar should be immediately blacklisted in traditional group"
    );
    ...
    let unblacklist_trad = maya
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "unblacklist_group_member", "group_id": "trad-group", "member_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        unblacklist_trad.is_success(),
        "Traditional group unblacklist should work directly"
    );
    ...
    let remove_attempt = nina
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "remove_group_member", "group_id": "md-restrict-group", "member_id": oscar.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        remove_attempt.is_success(),
        "remove_group_member should create proposal in member-driven group"
    );
    ...
    let is_oscar_still_member: bool = contract
        ...
        .json()?;
    assert!(
        is_oscar_still_member,
        "Oscar should still be member (removal requires proposal vote)"
    );
    ...
    let oscar_self_leave = oscar
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "leave_group", "group_id": "md-restrict-group" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    if !oscar_self_leave.is_success() {
        println!(
            "      ⚠ Oscar self-leave failed: {:?}",
            oscar_self_leave.failures()
        );
    }
    assert!(
        oscar_self_leave.is_success(),
        "Self-removal via leave_group should work"
    );
    ...
    assert!(
        !is_oscar_gone,
        "Oscar should not be member after self-removal"
    );
    ...
    assert!(
        grant_write_for.is_success(),
        "Granting write permission should succeed: {:?}",
        grant_write_for.outcome()
    );
    ...
    assert!(
        set_for_result.is_success(),
        "cross-account set should succeed with permission"
    );
    ...
    assert!(
        !unauthorized_set_for.is_success(),
        "Unauthorized cross-account set should fail"
    );
    ...
    let create_cancel_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "cancel-test-group", "config": {
                "is_private": true,
    ...
    assert!(
        create_cancel_group.is_success(),
        "Creating cancel-test-group should succeed"
    );
    ...
    let eve_join_request = eve
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "cancel-test-group" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        eve_join_request.is_success(),
        "Eve's join request should succeed"
    );
    ...
    let count_after_eve_request = stats_after_eve_request
        ...
        .unwrap_or(0);
    assert_eq!(
        count_after_eve_request,
        count_before_eve + 1,
        "Count should increment on join request"
    );
    println!(
        "   ✓ JOIN REQUEST COUNT INCREMENTED: {} -> {}",
        count_before_eve, count_after_eve_request
    );
    ...
    assert!(
        eve_request.is_some(),
        "Eve should have a pending join request"
    );
    ...
    let cancel_request = eve
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "cancel_join_request", "group_id": "cancel-test-group" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let count_after_cancel = stats_after_cancel
        ...
        .unwrap_or(0);
    assert_eq!(
        count_after_cancel, count_before_eve,
        "Count should decrement on cancel"
    );
    println!(
        "   ✓ JOIN REQUEST COUNT DECREMENTED ON CANCEL: {} -> {}",
        count_after_eve_request, count_after_cancel
    );
    ...
    assert!(
        eve_request_after.is_none(),
        "Eve's request should be cancelled"
    );
    ...
    assert!(
        has_write,
        "Bob should have WRITE permission on Alice's /relayed"
    );
    ...
    let gov_config: serde_json::Value = contract.view("get_config").await?.json()?;
    ...
    assert!(
        create_pool.is_success(),
        "Creating shared pool should succeed"
    );
    ...
    assert!(
        eve_write_shared.is_success(),
        "Eve should be able to write using shared storage"
    );
    ...
    let enter_read_only = contract.call("enter_read_only").transact().await?;
    ...
    if enter_read_only.is_success() {
        ...
        // Resume live mode
        let resume_live = contract.call("resume_live").transact().await?;
    ...
    assert!(
        set_perm_direct.is_success(),
        "set_permission should succeed: {:?}",
        set_perm_direct.outcome()
    );
    ...
    let long_group_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": long_group_id, "config": { "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let special_group_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "test<script>alert('xss')</script>group", "config": { "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if special_group_result.is_failure() {
        ...
        println!(
            "   ⚠ Group ID with special chars was accepted (sanitization may happen elsewhere)"
        );
    }
    ...
    if zero_perm_result.is_success() {
        ...
        println!(
            "   ⚠ Zero permission flags rejected: {:?}",
            zero_perm_result.failures().first()
        );
    }
    ...
    let voting_config_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "voting_config_test_group", "config": { "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let expiry_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "expiry_test_group", "config": { "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let quorum_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "quorum_boundary_group", "config": { "is_private": true } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
                ...
                if let Some(props) = proposals {
                    if let Some(last) = props.last() {
                        ...
                        if let Some(props) = updated {
                            if let Some(prop) = props.iter().find(|p| {
                                p.get("id").and_then(|v| v.as_u64()).unwrap_or(0) as u32 == prop_id
                            }) {
                                let status = prop
                                    .get("status")
                                    .and_then(|s| s.as_str())
    ...
    let single_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "single_member_group", "config": { "is_private": true } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let double_vote_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "double_vote_test", "config": { "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    println!(
        "   ✓ Get with return_deleted: {:?}",
        data_with_deleted.is_some()
    );
    ...
    let genesis_status: serde_json::Value = contract.view("get_contract_status").await?.json()?;
    ...
    let direct_add_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "direct_add_test", "config": { "is_private": true } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if direct_add_group.is_success() {
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "direct_add_test", "member_id": carol.id().to_string() }
            }
        }))
            .deposit(near_workspaces::types::NearToken::from_millinear(10))
            .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let join_req_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "join_request_test", "config": { "is_private": true } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if join_req_group.is_success() {
        ...
        let _ = bob
            ...
            .args_json(json!({
                "request": {
                    "action": { "type": "join_group", "group_id": "join_request_test" }
                }
            }))
            .deposit(near_workspaces::types::NearToken::from_millinear(10))
            .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        if join_request.is_some() {
            println!(
                "   ✓ get_join_request() returned pending request: {:?}",
                join_request
            );
        } else {
            println!(
                "   ⚠ get_join_request() returned None (may be auto-approved or different flow)"
            );
        }
    }
    ...
    if is_alice_member && !is_random_member {
        ...
        println!(
            "   ⚠ is_group_member() results: alice={}, random={}",
            is_alice_member, is_random_member
        );
    }
    ...
    if is_alice_owner && !is_bob_owner {
        ...
        println!(
            "   ⚠ is_group_owner() results: alice={}, bob={}",
            is_alice_owner, is_bob_owner
        );
    }
    ...
    let carol_leave = carol
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "leave_group", "group_id": "direct_add_test" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    if carol_leave.is_success() {
        ...
        if !still_member {
            ...
            let rejoin = carol
                ...
                .args_json(json!({
                    "request": {
                        "action": { "type": "join_group", "group_id": "direct_add_test" }
                    }
                }))
                .deposit(near_workspaces::types::NearToken::from_millinear(10))
                .gas(near_workspaces::types::Gas::from_tgas(100))
            ...
            if rejoin.is_success() {
                println!(
                    "   ✓ Carol can rejoin after leaving (creates join request for private group)"
                );
            } else {
    ...
    if event_test.is_success() {
        ...
        let has_event_log = logs
            .iter()
            .any(|log| log.contains("onsocial") || log.contains("EVENT"));
        ...
        if has_perm_event {
            ...
            if let Some(event_log) = logs.iter().find(|log| log.starts_with("EVENT_JSON:")) {
                if let Some(event) = decode_event(event_log) {
                    ...
                    println!(
                        "      Operation: {}",
                        get_event_operation(&event).unwrap_or("")
                    );
                    assert!(
                        event.event == "PERMISSION_UPDATE"
                            || get_event_operation(&event).unwrap_or("") == "grant",
    ...
    let group_create = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "event_test_group", "config": { "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if group_create.is_success() {
        ...
        if !event_logs.is_empty() {
            println!(
                "   ✓ GROUP_UPDATE event emitted on create_group ({} events)",
                event_logs.len()
            );
            ...
            for event_log in &event_logs {
                if let Some(event) = decode_event(event_log) {
                    if event.event == "GROUP_UPDATE" {
                        println!(
                            "      ✓ Found GROUP_UPDATE event, operation: {}",
                            get_event_operation(&event).unwrap_or("")
                        );
                    }
                }
    ...
    let group_join = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "event_test_group" }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(10))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let group_leave = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "leave_group", "group_id": "event_test_group" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let add_member = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "event_test_group", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(10))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let blacklist = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "event_test_group", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(10))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "transfer_event_group", "config": { "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "transfer_event_group", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(10))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let transfer = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "transfer_group_ownership", "group_id": "transfer_event_group", "new_owner": bob.id().to_string(), "remove_old_owner": null }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(10))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "proposal_event_group", "config": { "member_driven": true, "is_private": false } }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "proposal_event_group", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(10))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let create_prop = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "proposal_event_group", "proposal_type": "Custom", "changes": { "action": "test_event" }, "auto_vote": null }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    if create_prop.is_success() {
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "proposal_event_group", "proposal_id": proposal_id, "approve": true }
            }
        }))
        ...
        if let Some(event_log) = logs.iter().find(|log| log.starts_with("EVENT_JSON:")) {
            if let Some(event) = decode_event(event_log) {
                if let Some(data) = event.data.first() {
                    ...
                    assert!(
                        !get_event_operation(&event).unwrap_or("").is_empty(),
...
async fn test_governance_edge_cases() -> anyhow::Result<()> {
    ...
    let create_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "governance-test-group", "config": {
                "member_driven": true,
                "is_private": true,
    ...
    let add_bob = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "governance-test-group", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let create_proposal_no_vote = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "governance-test-group", "proposal_type": "custom_proposal", "changes": {
    ...
    assert!(
        create_proposal_no_vote.is_success(),
        "Creating proposal with auto_vote=false should succeed: {:?}",
        create_proposal_no_vote.failures()
    );
    let create_proposal_no_vote_logs: Vec<String> = create_proposal_no_vote
        .logs()
        .iter()
        .map(|s| s.to_string())
        .collect();
    ...
    println!(
        "   ✓ Created proposal without auto-vote: {}",
        proposal_id_no_vote
    );
    ...
    // Event schema assertions (auto_vote=false => proposal_created must include tally write)
    {
        let expected_tally_path = format!(
            "groups/{}/votes/{}",
            "governance-test-group", proposal_id_no_vote
        );
        let proposal_created_events =
            find_events_by_operation(&create_proposal_no_vote_logs, "proposal_created");
        assert!(
    ...
    let bob_votes_later = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "governance-test-group", "proposal_id": proposal_id_no_vote.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        bob_votes_later.is_success(),
        "Bob should be able to vote on his own proposal when auto_vote=false: {:?}",
        bob_votes_later.failures()
    );
    ...
    assert!(
        create_proposal_auto_vote.is_success(),
        "Creating proposal with auto_vote=true should succeed: {:?}",
        create_proposal_auto_vote.failures()
    );
    let create_proposal_auto_vote_logs: Vec<String> = create_proposal_auto_vote
        .logs()
        .iter()
        .map(|s| s.to_string())
        .collect();
    ...
    println!(
        "   ✓ Created proposal with auto-vote: {}",
    ...
    // Event schema assertions (auto_vote=true => proposal_created omits tally write; vote_cast includes bps)
    {
        let expected_tally_path = format!(
            "groups/{}/votes/{}",
            "governance-test-group", proposal_id_auto_vote
        );

        let proposal_created_events =
            find_events_by_operation(&create_proposal_auto_vote_logs, "proposal_created");
        let vote_cast_events =
            find_events_by_operation(&create_proposal_auto_vote_logs, "vote_cast");
    ...
    let bob_double_vote = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "governance-test-group", "proposal_id": proposal_id_auto_vote.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        !bob_double_vote.is_success(),
        "Bob should NOT be able to vote again when auto_vote=true (double voting)"
    );
    ...
    assert!(
        create_proposal_default.is_success(),
        "Creating proposal without specifying auto_vote should succeed: {:?}",
        create_proposal_default.failures()
    );
    let proposal_id_default: String = create_proposal_default.json()?;
    println!(
        "   ✓ Created proposal with default auto-vote: {}",
        proposal_id_default
    );
    ...
    let alice_double_vote = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "governance-test-group", "proposal_id": proposal_id_default.clone(), "approve": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        !alice_double_vote.is_success(),
        "Alice should NOT be able to vote again (default auto-vote)"
    );
    ...
    let add_carol = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "governance-test-group", "member_id": "carol.test.near" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    if let Some(carol_proposal_id) = carol_proposal_id {
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "governance-test-group", "proposal_id": carol_proposal_id, "approve": true }
            }
        }))
            .deposit(ONE_NEAR)
            .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let bob_vote = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "governance-test-group", "proposal_id": locked_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    for log in &bob_logs {
        if let Some(event) = decode_event(log) {
            if get_event_operation(&event).unwrap_or("") == "proposal_executed"
                || get_event_operation(&event).unwrap_or("") == "proposal_approved"
            {
...
async fn test_governance_direct_query_functions() -> anyhow::Result<()> {
    ...
    let add_bob = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group_id, "member_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let proposal_id = match proposal_id {
        ...
        None => {
            ...
            println!(
                "   ⚠ Got proposal_id from return value (events not parsed): {}",
                id
            );
            id
        }
    ...
    let proposal: serde_json::Value = alice
        .view(contract.id(), "get_proposal")
        .args_json(json!({
            "group_id": group_id,
    ...
    let tally: serde_json::Value = alice
        .view(contract.id(), "get_proposal_tally")
        .args_json(json!({
            "group_id": group_id,
            "proposal_id": &proposal_id
        }))
    ...
    let alice_vote_opt: Option<serde_json::Value> = alice
        .view(contract.id(), "get_vote")
        .args_json(json!({
            "group_id": group_id,
            "proposal_id": &proposal_id,
            "voter": alice.id()
    ...
    assert!(
        alice_vote_opt.is_some(),
        "Alice should have a vote (auto-voted)"
    );
    ...
    let bob_vote_before: Option<serde_json::Value> = alice
        .view(contract.id(), "get_vote")
        .args_json(json!({
            "group_id": group_id,
            "proposal_id": &proposal_id,
    ...
    bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": &proposal_id, "approve": false }
            }
        }))
    ...
    let bob_vote_after_opt: Option<serde_json::Value> = alice
        .view(contract.id(), "get_vote")
        .args_json(json!({
            "group_id": group_id,
            "proposal_id": &proposal_id,
    ...
    assert!(
        bob_vote_after_opt.is_some(),
        "Bob should have a vote after voting"
    );
    ...
    let tally_after: serde_json::Value = alice
        .view(contract.id(), "get_proposal_tally")
        .args_json(json!({
            "group_id": group_id,
            "proposal_id": &proposal_id
    ...
    let missing_group_proposal: Option<serde_json::Value> = alice
        .view(contract.id(), "get_proposal")
        .args_json(json!({
        ...
        .json()?;
    assert!(
        missing_group_proposal.is_none(),
    ...
    let missing_proposal: Option<serde_json::Value> = alice
        .view(contract.id(), "get_proposal")
        .args_json(json!({
            "group_id": group_id,
    ...
    let missing_tally: Option<serde_json::Value> = alice
        .view(contract.id(), "get_proposal_tally")
        .args_json(json!({
            "group_id": group_id,
            "proposal_id": "nonexistent-proposal-id"
        ...
        .json()?;
    assert!(
        missing_tally.is_none(),
        "Non-existent proposal tally should return None"
    );
    println!("   ✓ get_proposal_tally() returns None for non-existent proposal");

    // Test 10: get_vote for non-existent proposal
    let missing_vote: Option<serde_json::Value> = alice
        .view(contract.id(), "get_vote")
        .args_json(json!({
            "group_id": group_id,
            "proposal_id": "nonexistent-proposal-id",
        ...
        .json()?;
    assert!(
        missing_vote.is_none(),
        "Vote on non-existent proposal should return None"
    );
...
async fn test_owner_override_can_propose_vote_bypass_joined_at() -> anyhow::Result<()> {
    ...
    let create_group = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "owner-override-test", "config": {
                "member_driven": true,
                "is_private": true,
                "voting_config": {
    ...
    let add_member1 = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "owner-override-test", "member_id": member1.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let add_member2_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "owner-override-test", "member_id": member2.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        add_member2_proposal.is_success(),
        "Creating proposal to add member2 should succeed"
    );

    // Member1 votes YES to add member2
    // Extract proposal ID from logs
    let proposal_id_member2 =
        extract_proposal_id_from_logs(&add_member2_proposal.logs(), "proposal_created")
            .unwrap_or_default();
    ...
    let member1_vote = member1
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "owner-override-test", "proposal_id": proposal_id_member2, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        member1_vote.is_success(),
        "Member1 vote should succeed and execute"
    );
    ...
    let owner_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "owner-override-test", "proposal_type": "group_update", "changes": {
    ...
    assert!(
        owner_proposal.is_success(),
        "Owner should be able to create proposals: {:?}",
        owner_proposal.failures()
    );
    ...
    println!(
        "   ✓ Owner successfully created proposal: {}",
        proposal_id_1
    );
    ...
    assert!(
        member1_proposal.is_success(),
        "Member1 should be able to create proposals"
    );
    ...
    let owner_vote = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "owner-override-test", "proposal_id": proposal_id_2.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        owner_vote.is_success(),
        "Owner should be able to vote: {:?}",
        owner_vote.failures()
    );
    println!(
        "   ✓ Owner successfully voted on proposal: {}",
        proposal_id_2
    );
    ...
    assert!(
        member2_proposal.is_success(),
        "Member2 should be able to create proposals"
    );
    ...
    let add_member3 = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "owner-override-test", "member_id": member3.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        add_member3.is_success(),
        "Creating proposal to add member3 should succeed"
    );

    // Vote to add member3 (owner and member1 vote YES)
    let proposal_id_member3 =
        extract_proposal_id_from_logs(&add_member3.logs(), "proposal_created").unwrap_or_default();
    ...
    let vote_add_member3 = member1
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "owner-override-test", "proposal_id": proposal_id_member3.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        vote_add_member3.is_success(),
        "Vote to add member3 should succeed"
    );
    ...
    let member3_vote_fail = member3
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "owner-override-test", "proposal_id": proposal_id_3.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        !member3_vote_fail.is_success(),
        "Member3 should NOT be able to vote (joined after proposal)"
    );
    ...
    assert!(
        owner_vote_bypass.is_success(),
        "Owner should be able to vote (bypasses joined_at check): {:?}",
        owner_vote_bypass.failures()
    );
    ...
    let blacklist_member3 = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "owner-override-test", "member_id": member3.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        blacklist_member3.is_success(),
        "Blacklisting member3 should succeed"
    );
    ...
    assert!(
        !banned_vote.is_success(),
        "Banned member should NOT be able to vote"
    );
...
async fn test_member_driven_group_full_cycle_happy_path() -> anyhow::Result<()> {
    ...
    let create_group = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "full-cycle-test", "config": {
                "member_driven": true,
    ...
    for log in &logs {
        if let Some(event) = decode_event(log) {
            if get_event_operation(&event).unwrap_or("") == "group_created"
                || get_event_operation(&event).unwrap_or("") == "group_update"
            {
    ...
    let add_alice = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "full-cycle-test", "member_id": alice.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        add_alice.is_success(),
        "Adding Alice should succeed: {:?}",
        add_alice.failures()
    );
    ...
    for log in add_alice.logs() {
        if let Some(event) = decode_event(log) {
            if get_event_operation(&event).unwrap_or("") == "member_added"
                || get_event_operation(&event).unwrap_or("") == "group_update"
            {
    ...
    let add_bob = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "full-cycle-test", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        add_bob.is_success(),
        "Creating proposal to add Bob should succeed"
    );
    ...
    let alice_vote_bob = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "full-cycle-test", "proposal_id": proposal_id_bob.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        alice_vote_bob.is_success(),
        "Alice vote should succeed and execute"
    );
    ...
    let add_carol = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "full-cycle-test", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        ...
        "Creating proposal to add Carol should succeed"
    );

    // Extract proposal ID
    let proposal_id_carol =
        extract_proposal_id_from_logs(&add_carol.logs(), "proposal_created").unwrap_or_default();
    ...
    let alice_vote_carol = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "full-cycle-test", "proposal_id": proposal_id_carol.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        alice_vote_carol.is_success(),
        "Alice vote should succeed and execute (2 out of 3 = 66% quorum): {:?}",
        alice_vote_carol.failures()
    );
    ...
    let add_dave = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "full-cycle-test", "member_id": dave.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        add_dave.is_success(),
        "Creating proposal to add Dave should succeed"
    );

    // Extract proposal ID
    let proposal_id_dave =
        extract_proposal_id_from_logs(&add_dave.logs(), "proposal_created").unwrap_or_default();
    ...
    let bob_vote_dave = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "full-cycle-test", "proposal_id": proposal_id_dave.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        carol_vote_dave.is_success(),
        "Carol vote should succeed and execute (75% quorum): {:?}",
        carol_vote_dave.failures()
    );
    ...
    let create_proposal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "full-cycle-test", "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        create_proposal.is_success(),
        "Proposal creation should succeed: {:?}",
        create_proposal.failures()
    );

    // Extract proposal ID and check events
    let proposal_event_count =
        find_events_by_operation(&create_proposal.logs(), "proposal_created").len();
    let main_proposal_id =
        extract_proposal_id_from_logs(&create_proposal.logs(), "proposal_created")
            .expect("Proposal ID should be extracted");
    ...
    let alice_vote = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "full-cycle-test", "proposal_id": main_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    for log in alice_vote.logs() {
        if let Some(event) = decode_event(log) {
            if get_event_operation(&event).unwrap_or("") == "vote_cast"
                || get_event_operation(&event).unwrap_or("").contains("vote")
            {
                vote_events += 1;
                println!(
                    "      Event: {} emitted",
    ...
    assert!(
        !dave_late_vote.is_success(),
        "Should NOT be able to vote after execution"
    );
...
async fn test_member_driven_group_full_cycle_rejection_path() -> anyhow::Result<()> {
    ...
    let create_group = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "rejection-test", "config": {
                "member_driven": true,
                "is_private": true,
    ...
    let _ = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "rejection-test", "member_id": alice.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let add_bob = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "rejection-test", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "rejection-test", "proposal_id": bob_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let add_carol = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "rejection-test", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "rejection-test", "proposal_id": carol_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let add_dave = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "rejection-test", "member_id": dave.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let _ = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "rejection-test", "proposal_id": dave_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let _ = carol
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "rejection-test", "proposal_id": dave_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let create_proposal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "rejection-test", "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        !main_proposal_id.is_empty(),
        "Proposal ID should be extracted"
    );
    println!("   ✓ Proposal created: {}", main_proposal_id);
    println!("   ✓ Proposal events emitted: {}", proposal_event_count);
    ...
    let alice_vote = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "rejection-test", "proposal_id": main_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let bob_vote = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "rejection-test", "proposal_id": main_proposal_id.clone(), "approve": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    for log in carol_vote.logs() {
        if let Some(event) = decode_event(log) {
            if get_event_operation(&event).unwrap_or("") == "proposal_rejected"
                || get_event_operation(&event).unwrap_or("").contains("reject")
            {
    ...
    let dave_vote = dave
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "rejection-test", "proposal_id": main_proposal_id.clone(), "approve": false }// Dave votes NO
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        dave_vote.is_success(),
        "Dave should be able to vote (defeat not inevitable yet)"
    );
    ...
    if rejection_triggered {
        ...
        assert!(
            !owner_late_vote.is_success(),
            "Should NOT be able to vote after inevitable defeat"
        );
...
async fn test_governance_security_and_edge_cases() -> anyhow::Result<()> {
    ...
    let create_solo_group = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "solo-group", "config": {
                "member_driven": true,
                "is_private": true,
    ...
    assert!(
        create_solo_group.is_success(),
        "Solo group creation should succeed"
    );
    ...
    let solo_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "solo-group", "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        solo_proposal.is_success(),
        "Solo proposal should succeed and auto-execute"
    );
    ...
    let create_expiry_group = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "expiry-test", "config": {
                "member_driven": true,
                "is_private": true,
                "voting_config": {
                    "participation_quorum_bps": 5100,
    ...
    assert!(
        create_expiry_group.is_success(),
        "Expiry test group creation should succeed"
    );
    ...
    let _ = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "expiry-test", "member_id": alice.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let expiry_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "expiry-test", "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        voting_period_sanitized,
        "Voting period should be sanitized to minimum 1 hour"
    );
    ...
    println!(
        "   ℹ Note: Actual expiration testing requires waiting 1+ hour (impractical in tests)"
    );
    ...
    let create_boundary_group = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "boundary-test", "config": {
                "member_driven": true,
                "is_private": true,
                "voting_config": {
    ...
    let _ = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "boundary-test", "member_id": alice.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let add_bob_boundary = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "boundary-test", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "boundary-test", "proposal_id": bob_add_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let boundary_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "boundary-test", "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    let owner_boundary_vote = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "boundary-test", "proposal_id": boundary_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let create_ban_group = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "ban-test", "config": {
                "member_driven": true,
                "is_private": true,
                "voting_config": {
                    "participation_quorum_bps": 5100,
    ...
    let add_bob = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "ban-test", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let add_carol = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "ban-test", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(near_workspaces::types::NearToken::from_millinear(100))
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    if !carol_proposal_id.is_empty() {
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "ban-test", "proposal_id": carol_proposal_id, "approve": true }
            }
        }))
            .deposit(ONE_NEAR)
            .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let blacklist_carol = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": "ban-test", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        blacklist_carol.is_success(),
        "Ban proposal creation should succeed"
    );
    ...
    assert!(
        !ban_proposal_id.is_empty(),
        "Should have created a ban proposal"
    );
    println!("   ✓ Ban proposal ID: {}", ban_proposal_id);
    ...
    let vote_ban = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "ban-test", "proposal_id": ban_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    println!(
        "   ℹ Carol blacklisted: {}, still member: {}",
        is_blacklisted, is_member
    );
    assert!(is_blacklisted, "Carol should be blacklisted");
    ...
    let banned_proposal = carol
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "ban-test", "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        !banned_proposal.is_success(),
        "Banned user should NOT be able to create proposals"
    );
    ...
    let nonexistent_vote = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "ban-test", "proposal_id": "nonexistent_proposal_12345", "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
...
async fn test_governance_advanced_security() -> anyhow::Result<()> {
    ...
    let create_result = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": group1_id, "config": {
                "member_driven": true,
                "is_private": true,
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group1_id, "member_id": alice.id() }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let add_bob = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group1_id, "member_id": bob.id() }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let bob_proposal_id =
        extract_proposal_id_from_logs(&add_bob.logs(), "proposal_created").unwrap_or_default();
    ...
    alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group1_id, "proposal_id": bob_proposal_id, "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let ban_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "blacklist_group_member", "group_id": group1_id, "member_id": alice.id() }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let ban_proposal_id =
        extract_proposal_id_from_logs(&ban_proposal.logs(), "proposal_created").unwrap_or_default();
    ...
    bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group1_id, "proposal_id": ban_proposal_id, "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    assert!(
        !alice_is_member,
        "Alice should not be a member after being blacklisted"
    );
    ...
    let test_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group1_id, "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        test_proposal.is_success(),
        "Proposal creation should succeed: {:?}",
        test_proposal.failures()
    );
    ...
    let alice_vote_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group1_id, "proposal_id": test_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        alice_vote_result.is_failure(),
        "Blacklisted user should not be able to vote"
    );
    ...
    assert!(
        ...
        "Error should mention blacklist, permission, or member: {:?}",
        alice_vote_result
    );
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": group2_id, "config": {
                "member_driven": true,
                "is_private": true,
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group2_id, "member_id": charlie.id() }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let proposal2 = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group2_id, "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    let proposal2_id =
        extract_proposal_id_from_logs(&proposal2.logs(), "proposal_created").unwrap_or_default();
    ...
    let add_david = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group2_id, "member_id": david.id() }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let david_proposal_id =
        extract_proposal_id_from_logs(&add_david.logs(), "proposal_created").unwrap_or_default();
    ...
    charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group2_id, "proposal_id": david_proposal_id, "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let david_vote = david
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group2_id, "proposal_id": proposal2_id, "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    assert!(
        david_vote.is_failure(),
        "Late joiner should not be able to vote"
    );
    let error_msg = format!("{:?}", david_vote).to_lowercase();
    assert!(
        error_msg.contains("joined")
            || error_msg.contains("after")
            || error_msg.contains("cannot vote"),
        "Error should mention joining after proposal creation: {:?}",
        david_vote
    );
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": group3_id, "config": {
                "member_driven": true,
                "is_private": true,
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group3_id, "member_id": alice.id() }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let proposal3 = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group3_id, "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        proposal3.is_success(),
        "Proposal should succeed with sanitized config"
    );

    let proposal3_id =
        extract_proposal_id_from_logs(&proposal3.logs(), "proposal_created").unwrap_or_default();
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group3_id, "proposal_id": proposal3_id, "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    assert!(
        proposal_executed,
        "Proposal should be executed with clamped voting config"
    );
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": group4_id, "config": {
                "member_driven": true,
                "is_private": true,
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group4_id, "member_id": bob.id() }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let active_proposal = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group4_id, "proposal_type": "group_update", "changes": {
                "update_type": "metadata",
                "changes": {
    ...
    assert!(
        actual_voting_period >= min_voting_period_ns,
        "Voting period should be sanitized to minimum 1 hour, got {} ns",
        actual_voting_period
    );
    println!("   ✓ Short voting period (1s) correctly sanitized to MIN_VOTING_PERIOD (1 hour)");
    println!(
        "   ✓ Actual voting_period in event: {} ns (expected >= {})",
        actual_voting_period, min_voting_period_ns
    );
    println!(
        "   ℹ Note: Actual expiration testing requires waiting 1+ hour (impractical in tests)"
...
async fn test_invalid_voting_config_change_proposals() -> anyhow::Result<()> {
    ...
    let invalid_quorum = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id, "proposal_type": "voting_config_change", "changes": {
    ...
    assert!(
        !negative_threshold.is_success(),
        "Should reject threshold < 0.0"
    );
    ...
    let empty_changes = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id, "proposal_type": "voting_config_change", "changes": {}, "auto_vote": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    assert!(
        valid_change.is_success(),
        "Valid proposal should succeed: {:?}",
        valid_change.failures()
    );
...
async fn test_duplicate_vote_check_before_expiration() -> anyhow::Result<()> {
    ...
    let proposal_id =
        extract_proposal_id_from_logs(&proposal.logs(), "proposal_created").expect("proposal");
    ...
    let second_vote = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": proposal_id, "approve": false }// Try to change vote
            }
        }))
...
async fn test_member_cannot_vote_on_pre_membership_proposal() -> anyhow::Result<()> {
    ...
    let _ = alice.call(contract.id(), "execute")
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group_id, "member_id": charlie.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .transact()
    ...
    let proposal_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id, "proposal_type": "custom_proposal", "changes": {"title": "Pre-Eve", "description": "Created before Eve joined", "custom_data": {}}, "auto_vote": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let _ = alice.call(contract.id(), "execute")
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group_id, "member_id": eve.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .transact()
    ...
    assert!(
        ...
        "New member should not be able to vote on old proposals"
    );
    let error_msg = format!("{:?}", vote_result.failures());
    assert!(
        error_msg.contains("Permission denied") || error_msg.contains("Cannot vote"),
...
async fn test_expired_proposal_rejects_votes() -> anyhow::Result<()> {
    ...
    let proposal_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id, "proposal_type": "custom_proposal", "changes": {"title": "Expiry Test", "description": "Will expire", "custom_data": {}}, "auto_vote": false }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
...
async fn test_voting_config_change_during_active_voting() -> anyhow::Result<()> {
    ...
    let proposal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id, "proposal_type": "custom_proposal", "changes": {"title": "Test", "description": "Testing config behavior", "custom_data": {}}, "auto_vote": false } }// Don't auto-vote
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
        .await?;
...
async fn test_governance_critical_security_scenarios() -> anyhow::Result<()> {
    ...
    let proposal_a = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id, "proposal_type": "group_update", "changes": {
    ...
    let proposal_b = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id, "proposal_type": "permission_grant", "changes": {
                "target_user": bob.id().to_string(),
    ...
    let _ = charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": proposal_a_id, "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    if !bob_is_member {
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": proposal_b_id, "approve": true }
            }
        }))
            .deposit(NearToken::from_millinear(100))
            .transact()
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": group_id2, "config": {
                "is_private": true,
                "member_driven": true
            } }
            }
    ...
    let invalid_proposal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": group_id2, "proposal_type": "group_update", "changes": {
                "update_type": "remove_member",
...
async fn test_governance_event_emissions() -> anyhow::Result<()> {
        ...
        if let Some(event) = decode_event(log) {
            if get_event_operation(&event).unwrap_or("") == "proposal_created" {
                ...
                if let Some(data) = event.data.first() {
                        ...
                        match key.as_str() {
                            ...
                            "participation_quorum_bps" => {
                                    ...
                                    .as_deref()
                                {
                                    ...
                                    assert_eq!(
                                        quorum_bps, 5100,
                                        "Quorum should be 5100 bps (51.00%)"
                                    );
                                }
                            }
                            "majority_threshold_bps" => {
                                    ...
                                    .as_deref()
                                {
                                    ...
                                    assert_eq!(
                                        threshold_bps, 5100,
                                        "Threshold should be 5100 bps (51.00%)"
                                    );
                                }
                            }
                            "voting_period" => {
                    ...
                    assert!(
                        has_proposal_id,
                        "proposal_created event missing proposal_id"
                    );
                    assert!(
                        has_sequence_number,
                        "proposal_created event missing sequence_number"
                    );
                    assert!(
                        has_proposal_type,
                        "proposal_created event missing proposal_type"
                    );
                    ...
                    assert!(
                        has_locked_member_count,
                        "proposal_created event missing locked_member_count"
                    );
                    assert!(
                        has_participation_quorum_bps,
                        "proposal_created event missing participation_quorum_bps"
                    );
                    assert!(
                        has_majority_threshold_bps,
                        "proposal_created event missing majority_threshold_bps"
                    );
                    assert!(
                        has_voting_period,
                        "proposal_created event missing voting_period"
                    );
                    assert!(
                        has_proposal_data,
                        "proposal_created event missing proposal_data"
                    );
                    ...
                    println!(
                        "      - locked_member_count: {} (locked at creation)",
                        locked_count
                    );
                ...
                if let Some(data) = event.data.first() {
                        ...
                        match key.as_str() {
                            ...
                            "participation_bps" => {
                                ...
                                assert!(
                                    ...
                                    "Participation bps should be 1..=10000"
                                );
                            }
                            "approval_bps" => {
                                ...
                                assert_eq!(
                                    approval_bps, 10_000,
                                    "Approval should be 10000 bps (100%)"
                                );
                            }
                    ...
                    assert!(
                        has_locked_member_count,
                        "vote_cast event missing locked_member_count"
                    );
                    assert!(
                        has_participation_bps,
                        "vote_cast event missing participation_bps"
                    );
    ...
    assert!(
        vote_cast_found,
        "vote_cast event not found (auto_vote=true should emit)"
    );
    ...
    let bob_vote = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": proposal_id.clone(), "approve": false }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
        ...
        if let Some(event) = decode_event(log) {
            if get_event_operation(&event).unwrap_or("") == "vote_cast" {
                ...
                if let Some(data) = event.data.first() {
                    ...
                    assert!(
                        has_should_reject,
                        "vote_cast event should include should_reject"
                    );
    ...
    let _ = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": exec_proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    let execute_vote = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": exec_proposal_id, "approve": true }
            }
        }))
        .deposit(NearToken::from_millinear(100))
        .transact()
    ...
    assert!(
        should_execute_true_found,
        "should_execute flag should be true when threshold met"
    );
    ...
    println!(
        "   • proposal_created: group_id, proposal_id, sequence_number, proposal_type, auto_vote"
    );
...
async fn test_view_state_prefix_query() -> anyhow::Result<()> {
    ...
    println!(
        "\n5. Alice's posts (filtered by prefix '{}'):",
        alice_posts_prefix
    );
    ...
    println!(
        "\n6. Alice's profile (filtered by prefix '{}'):",
        alice_profile_prefix
    );
    ...
    println!(
        "\n7. Bob's posts (filtered by prefix '{}'):",
        bob_posts_prefix
    );
...
async fn test_cancel_proposal_before_any_votes() -> anyhow::Result<()> {
    ...
    let create_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "cancel-group", "config": { "member_driven": true, "is_private": true } }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let add_bob = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "cancel-group", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
    ...
    let create_proposal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "cancel-group", "proposal_type": "custom_proposal", "changes": {
    ...
    let cancel = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "cancel_proposal", "group_id": "cancel-group", "proposal_id": proposal_id.clone() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(120))
    ...
    assert!(
        ...
        "proposal_status_updated event must be emitted on cancellation"
    );
    ...
    let final_total = ps_extra
        .get("final_total_votes")
        .and_then(|v| v.as_u64())
        .unwrap_or(999);
    let final_yes = ps_extra
        .get("final_yes_votes")
        .and_then(|v| v.as_u64())
        .unwrap_or(999);
    let final_no = ps_extra
        .get("final_no_votes")
        .and_then(|v| v.as_u64())
        .unwrap_or(999);
    assert_eq!(
        final_total, 0,
        "final_total_votes should be 0 (no votes cast)"
    );
...
async fn test_cancel_proposal_blocked_after_other_member_votes() -> anyhow::Result<()> {
    ...
    let create_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "cancel-group-2", "config": { "member_driven": true, "is_private": true } }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let add_bob = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "cancel-group-2", "member_id": bob.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(120))
    ...
    let add_carol = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "cancel-group-2", "member_id": carol.id().to_string() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(120))
    ...
    let create_proposal = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_proposal", "group_id": "cancel-group-2", "proposal_type": "custom_proposal", "changes": {
    ...
    let bob_vote = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": "cancel-group-2", "proposal_id": proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let cancel = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "cancel_proposal", "group_id": "cancel-group-2", "proposal_id": proposal_id }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(120))
    ...
    assert!(
        !cancel.is_success(),
        "Cancellation should be blocked after another member votes"
    );
...
async fn test_admin_event_paths_format() -> anyhow::Result<()> {
    ...
    println!(
        "   ✓ update_config event has correct path: {}",
    ...
    assert!(
        !manager_events.is_empty(),
        "Should emit update_manager event"
    );
    ...
    println!(
        "   ✓ update_manager event has correct path: {}",
        expected_manager_path
    );
...
async fn test_group_endpoints_edge_cases() -> anyhow::Result<()> {
    ...
    let create_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "edge-test-group", "config": {
                "is_private": true
            } }
            }
        }))
    ...
    let owner_leave_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "leave_group", "group_id": "edge-test-group" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    assert!(
        owner_leave_error.contains("Transfer ownership")
            || owner_leave_error.contains("Owner cannot leave"),
    ...
    let non_owner_privacy_result = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "set_group_privacy", "group_id": "edge-test-group", "is_private": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        privacy_error.contains("permission")
            || privacy_error.contains("denied")
            || privacy_error.contains("set_group_privacy"),
    ...
    let add_bob = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": "edge-test-group", "member_id": bob.id() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let non_owner_transfer_result = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "transfer_group_ownership", "group_id": "edge-test-group", "new_owner": charlie.id().to_string(), "remove_old_owner": null }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        transfer_error.contains("permission")
            || transfer_error.contains("denied")
            || transfer_error.contains("transfer_ownership"),
        "Error should indicate permission denial, got: {}",
        transfer_error
    );
    ...
    let charlie_join_request = charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "join_group", "group_id": "edge-test-group" }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let non_requester_cancel = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "cancel_join_request", "group_id": "edge-test-group" }
            }
        }))
        .gas(near_workspaces::types::Gas::from_tgas(100))
        .transact()
    ...
    let charlie_cancel = charlie
        ...
        .await?;
    assert!(
        charlie_cancel.is_success(),
        "Charlie should be able to cancel their own request"
    );
    ...
    let same_privacy_result = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "set_group_privacy", "group_id": "edge-test-group", "is_private": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let member_driven_public_result = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "invalid-md-public", "config": {
                "member_driven": true,
                "is_private": false
            } }
            }
    ...
    let large_config_result = bob
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "large-config-group", "config": {
    ...
    let charlie_group_result = charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "charlie-group", "config": {} }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        charlie_group_result.is_success(),
        "Charlie group creation should succeed"
    );
    ...
    let md_privacy_group = charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "md-privacy-test", "config": {
                "member_driven": true,
                "is_private": true
            } }
            }
    ...
    let md_privacy_change = charlie
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "set_group_privacy", "group_id": "md-privacy-test", "is_private": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        md_privacy_error.contains("private")
            || md_privacy_error.contains("democratic")
            || md_privacy_error.contains("Member-driven"),
    ...
    let nonexistent_privacy = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "set_group_privacy", "group_id": "nonexistent-group-xyz-123", "is_private": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let metadata_test_group = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "create_group", "group_id": "privacy-metadata-test", "config": {
                "is_private": true
            } }
            }
        }))
        ...
        .await?;
    assert!(
        metadata_test_group.is_success(),
        "Group creation should succeed"
    );
    ...
    let metadata_privacy_change = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "set_group_privacy", "group_id": "privacy-metadata-test", "is_private": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
        ...
        .await?;
    assert!(
        metadata_privacy_change.is_success(),
        "Privacy change should succeed"
    );
    ...
    let empty_group_id_privacy = alice
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "set_group_privacy", "group_id": "", "is_private": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    assert!(
        empty_id_error.contains("1-64 characters")
            || empty_id_error.contains("Group ID")
            || empty_id_error.contains("group_id"),
...
async fn test_governance_events_schema_completeness() -> anyhow::Result<()> {
    ...
    owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group_id, "member_id": member1.id() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(100))
    ...
    let add_member2 = owner
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "add_group_member", "group_id": group_id, "member_id": member2.id() }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let add_member2_proposal_id =
        extract_proposal_id_from_logs(&add_member2.logs(), "proposal_created")
    ...
    member1
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": add_member2_proposal_id, "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    let proposal_created_events =
        find_events_by_operation(&create_proposal.logs(), "proposal_created");
    assert!(
        !proposal_created_events.is_empty(),
    ...
    assert!(
        pc_extra.contains_key("group_id"),
        "proposal_created must have group_id"
    );
    assert!(
        pc_extra.contains_key("proposal_id"),
        "proposal_created must have proposal_id"
    );
    assert!(
        pc_extra.contains_key("sequence_number"),
        "proposal_created must have sequence_number"
    );
    assert!(
        pc_extra.contains_key("proposal_type"),
        "proposal_created must have proposal_type"
    );
    assert!(
        pc_extra.contains_key("proposer"),
        "proposal_created must have proposer"
    );
    assert!(
        pc_extra.contains_key("target"),
        "proposal_created must have target"
    );
    assert!(
        pc_extra.contains_key("auto_vote"),
        "proposal_created must have auto_vote"
    );
    assert!(
        pc_extra.contains_key("created_at"),
        "proposal_created must have created_at"
    );
    assert!(
        pc_extra.contains_key("expires_at"),
        "proposal_created must have expires_at"
    );
    assert!(
        pc_extra.contains_key("locked_member_count"),
        "proposal_created must have locked_member_count"
    );
    assert!(
        pc_extra.contains_key("participation_quorum_bps"),
        "proposal_created must have participation_quorum_bps"
    );
    assert!(
        pc_extra.contains_key("majority_threshold_bps"),
        "proposal_created must have majority_threshold_bps"
    );
    assert!(
        pc_extra.contains_key("voting_period"),
        "proposal_created must have voting_period"
    );
    assert!(
        pc_extra.contains_key("locked_deposit"),
        "proposal_created must have locked_deposit"
    );
    assert!(
        pc_extra.contains_key("path"),
        "proposal_created must have path"
    );
    assert!(
        pc_extra.contains_key("value"),
        "proposal_created must have value"
    );
    assert!(
        pc_extra.contains_key("tally_path"),
        "proposal_created must have tally_path"
    );
    assert!(
        pc_extra.contains_key("counter_path"),
        "proposal_created must have counter_path"
    );
    assert!(
        pc_extra.contains_key("writes"),
        "proposal_created must have writes"
    );

    // Verify expires_at = created_at + voting_period
    let created_at: u64 = pc_extra
        .get("created_at")
        .and_then(|v| v.as_str().and_then(|s| s.parse().ok()))
        .expect("created_at should be parseable");
    let expires_at: u64 = pc_extra
        .get("expires_at")
        .and_then(|v| v.as_str().and_then(|s| s.parse().ok()))
        .expect("expires_at should be parseable");
    let voting_period: u64 = pc_extra
        .get("voting_period")
        .and_then(|v| v.as_str().and_then(|s| s.parse().ok()))
    ...
    assert_eq!(
        expires_at,
        created_at.saturating_add(voting_period),
        "expires_at must equal created_at + voting_period"
    );

    // Verify locked_member_count is 3 (snapshot at proposal creation)
    let locked_member_count = pc_extra
    ...
    let writes = pc_extra
        ...
        .expect("writes should be array");
    let counter_path = pc_extra
        .get("counter_path")
        .and_then(|v| v.as_str())
        .expect("counter_path");
    let has_counter_write = writes
        .iter()
        .any(|w| w.get("path").and_then(|p| p.as_str()) == Some(counter_path));
    ...
    println!(
        "   ✓ expires_at correctly computed: {} + {} = {}",
        created_at, voting_period, expires_at
    );
    println!(
        "   ✓ locked_member_count correctly captured: {}",
        locked_member_count
    );
    ...
    let vote_result = member1
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": proposal_id.clone(), "approve": true }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    assert!(
        !vote_cast_events.is_empty(),
        "vote_cast event must be emitted"
    );
    ...
    // Verify required fields
    assert!(
        vc_extra.contains_key("group_id"),
        "vote_cast must have group_id"
    );
    assert!(
        vc_extra.contains_key("proposal_id"),
        "vote_cast must have proposal_id"
    );
    assert!(vc_extra.contains_key("voter"), "vote_cast must have voter");
    assert!(
        vc_extra.contains_key("approve"),
        "vote_cast must have approve"
    );
    assert!(
        vc_extra.contains_key("total_votes"),
        "vote_cast must have total_votes"
    );
    assert!(
        vc_extra.contains_key("yes_votes"),
        "vote_cast must have yes_votes"
    );
    assert!(
        vc_extra.contains_key("no_votes"),
        "vote_cast must have no_votes"
    );
    assert!(
        vc_extra.contains_key("locked_member_count"),
        "vote_cast must have locked_member_count"
    );
    assert!(
        vc_extra.contains_key("participation_bps"),
        "vote_cast must have participation_bps"
    );
    assert!(
        vc_extra.contains_key("approval_bps"),
        "vote_cast must have approval_bps"
    );
    assert!(
        vc_extra.contains_key("should_execute"),
        "vote_cast must have should_execute"
    );
    assert!(
        vc_extra.contains_key("should_reject"),
        "vote_cast must have should_reject"
    );
    assert!(vc_extra.contains_key("path"), "vote_cast must have path");
    assert!(vc_extra.contains_key("value"), "vote_cast must have value");
    assert!(
        vc_extra.contains_key("tally_path"),
        "vote_cast must have tally_path"
    );
    assert!(
        vc_extra.contains_key("writes"),
        "vote_cast must have writes"
    );
    assert!(
        vc_extra.contains_key("voted_at"),
        "vote_cast must have voted_at"
    );

    // Verify tally math
    let total_votes = vc_extra
        .get("total_votes")
        .and_then(|v| v.as_u64())
        .expect("total_votes");
    let yes_votes = vc_extra
        .get("yes_votes")
        .and_then(|v| v.as_u64())
        .expect("yes_votes");
    let no_votes = vc_extra
        .get("no_votes")
        .and_then(|v| v.as_u64())
        .expect("no_votes");
    assert_eq!(
    ...
    let participation_bps = vc_extra
        .get("participation_bps")
        .and_then(|v| v.as_u64())
        .expect("participation_bps");
    let approval_bps = vc_extra
        .get("approval_bps")
        .and_then(|v| v.as_u64())
        .expect("approval_bps");
    let vc_locked = vc_extra
        .get("locked_member_count")
        .and_then(|v| v.as_u64())
        .expect("locked_member_count");
    ...
    assert_eq!(
        participation_bps, expected_participation,
        "participation_bps calculation"
    );
    ...
    let should_execute = vc_extra
        .get("should_execute")
        .and_then(|v| v.as_bool())
        .expect("should_execute");
    assert!(
        should_execute,
        "should_execute must be true after quorum reached"
    );

    let should_reject = vc_extra
        .get("should_reject")
        .and_then(|v| v.as_bool())
        .expect("should_reject");
    ...
    println!(
        "   ✓ participation_bps correctly computed: {}",
        participation_bps
    );
    ...
    assert!(
        !status_events.is_empty(),
        "proposal_status_updated event must be emitted on execution"
    );
    ...
    assert!(
        ps_extra.contains_key("group_id"),
        "proposal_status_updated must have group_id"
    );
    assert!(
        ps_extra.contains_key("proposal_id"),
        "proposal_status_updated must have proposal_id"
    );
    assert!(
        ps_extra.contains_key("proposer"),
        "proposal_status_updated must have proposer"
    );
    assert!(
        ps_extra.contains_key("status"),
        "proposal_status_updated must have status"
    );
    assert!(
        ps_extra.contains_key("final_total_votes"),
        "proposal_status_updated must have final_total_votes"
    );
    assert!(
        ps_extra.contains_key("final_yes_votes"),
        "proposal_status_updated must have final_yes_votes"
    );
    assert!(
        ps_extra.contains_key("final_no_votes"),
        "proposal_status_updated must have final_no_votes"
    );
    assert!(
        ps_extra.contains_key("locked_member_count"),
        "proposal_status_updated must have locked_member_count"
    );
    assert!(
        ps_extra.contains_key("unlocked_deposit"),
        "proposal_status_updated must have unlocked_deposit"
    );
    assert!(
        ps_extra.contains_key("updated_at"),
        "proposal_status_updated must have updated_at"
    );
    assert!(
        ps_extra.contains_key("path"),
        "proposal_status_updated must have path"
    );
    assert!(
        ps_extra.contains_key("value"),
        "proposal_status_updated must have value"
    );
    ...
    member1
        ...
        .args_json(json!({
            "request": {
                "action": { "type": "vote_on_proposal", "group_id": group_id, "proposal_id": reject_proposal_id.clone(), "approve": false }
            }
        }))
        .deposit(ONE_NEAR)
        .gas(near_workspaces::types::Gas::from_tgas(150))
    ...
    if !reject_vote_events.is_empty() {
        let rv_extra = &reject_vote_events[0]
            .data
            .first()
            .expect("event data")
            .extra;
        let should_reject_flag = rv_extra
            .get("should_reject")
            .and_then(|v| v.as_bool())
            .unwrap_or(false);
    ...
    let reject_status_events =
        find_events_by_operation(&reject_vote.logs(), "proposal_status_updated");
    assert!(
        !reject_status_events.is_empty(),
        "proposal_status_updated must be emitted on rejection"
    );

    let rs_extra = &reject_status_events[0]
        .data
        .first()
        .expect("event data")
        .extra;
    let reject_status = rs_extra
        .get("status")
        .and_then(|v| v.as_str())
        .expect("status");
    assert_eq!(reject_status, "rejected", "status must be 'rejected'");

    let final_total = rs_extra
        .get("final_total_votes")
        .and_then(|v| v.as_u64())
        .expect("final_total_votes");
    let final_yes = rs_extra
        .get("final_yes_votes")
        .and_then(|v| v.as_u64())
        .expect("final_yes_votes");
    let final_no = rs_extra
        .get("final_no_votes")
        .and_then(|v| v.as_u64())
        .expect("final_no_votes");
    ...
    let all_logs: Vec<String> = create_proposal
        .logs()
        .iter()
    ...
    for log in &all_logs {
        if let Some(event) = decode_event(log) {
            ...
            if let Some(data) = event.data.first() {
                ...
                assert!(
                    data.partition_id.is_some(),
                    "GROUP_UPDATE events must have partition_id"
                );
    ...
    assert!(
        events_checked > 0,
        "Should have checked at least one GROUP_UPDATE event"
    );
    println!(
        "   ✓ Verified {} events have consistent partition: {}",
        events_checked, expected_partition
    );
...
async fn test_status_transition_keys_rejected() -> anyhow::Result<()> {
    ...
    for (key, expected_method) in status_keys {
        ...
        assert!(!result.is_success(), "Set with '{}' key should fail", key);
        ...
        println!(
            "  ✓ '{}' correctly rejected with hint to use {}()",
            key, expected_method
        );
    }
...
async fn test_dispatch_return_values() -> anyhow::Result<()> {
    ...
    assert!(
        create_group_result.is_success(),
        "CreateGroup should succeed"
    );
    ...
    assert!(
        join_return.is_null(),
        "JoinGroup must return null, got: {:?}",
        join_return
    );
    ...
    assert!(
        perm_return.is_null(),
        "SetPermission must return null, got: {:?}",
        perm_return
    );
    ...
    assert!(
        proposal_result.is_success(),
        "CreateProposal should succeed: {:?}",
        proposal_result.failures()
    );
    ...
    assert!(
        leave_return.is_null(),
        "LeaveGroup must return null, got: {:?}",
        leave_return
    );
...
async fn test_dispatch_vote_returns_null() -> anyhow::Result<()> {
    ...
    assert!(
        ...
        "Invite proposal should succeed: {:?}",
    ...
    assert!(
        vote_return.is_null(),
        "VoteOnProposal must return null, got: {:?}",
        vote_return
    );
...
async fn test_valid_json_value_types_accepted() -> anyhow::Result<()> {
    ...
    assert_eq!(
        entry_value_str(&get_result, &format!("{}/profile/string_val", alice.id())),
        Some("a string")
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/number_val", alice.id())),
        Some(json!(42)).as_ref()
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/bool_val", alice.id())),
        Some(json!(true)).as_ref()
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/array_val", alice.id())),
        Some(json!([1, 2, 3])).as_ref()
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/object_val", alice.id())),
        Some(json!({"key": "value"})).as_ref()
    );
...
async fn test_data_value_payload_exactly_at_limit_passes() -> anyhow::Result<()> {
    ...
    let serialized_len = serde_json::to_vec(&json!(exact_limit_content))
        .unwrap()
        .len();
    assert_eq!(
    ...
    println!(
        "   ℹ Serialized value length: {} bytes (exactly at limit)",
        serialized_len
    );
...
async fn test_data_value_payload_one_byte_over_limit_fails() -> anyhow::Result<()> {
    ...
    println!(
        "   ℹ Serialized value length: {} bytes (one over limit)",
        serialized_len
    );
...
async fn test_data_value_empty_and_minimal_values_pass() -> anyhow::Result<()> {
    ...
    assert_eq!(
        entry_value_str(&get_result, &format!("{}/profile/empty", alice.id())),
        Some("")
    );
    assert_eq!(
        entry_value_str(&get_result, &format!("{}/profile/single_char", alice.id())),
        Some("x")
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/empty_object", alice.id())),
        Some(&json!({}))
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/empty_array", alice.id())),
        Some(&json!([]))
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/number_zero", alice.id())),
        Some(&json!(0))
    );
    assert_eq!(
        entry_value(&get_result, &format!("{}/profile/bool_false", alice.id())),
        Some(&json!(false))
    );
...
async fn test_first_write_emits_platform_sponsor_event() -> anyhow::Result<()> {
    ...
    let fund_result = contract
        ...
        .await?;
    assert!(
        fund_result.is_success(),
        "Platform pool funding should succeed: {:?}",
        fund_result.failures()
    );
    ...
    assert!(
        set_result.is_success(),
        "First write should succeed with platform sponsorship"
    );
    ...
    assert!(
        verify_event_base(event, "onsocial", "1.0.0"),
        "Event should have correct standard/version"
    );
    assert!(
        verify_event_author(event, &bob.id().to_string()),
        "Event author should be bob"
    );
    ...
    assert!(
        is_sponsored,
        "Bob should be platform_sponsored after first write"
    );
...
async fn test_attached_deposit_fallback_emits_event() -> anyhow::Result<()> {
    ...
    assert!(
        set_result.is_success(),
        "First write with deposit should succeed"
    );
    ...
    assert!(
        verify_event_author(event, &charlie.id().to_string()),
        "Event author should be charlie"
    );
    ...
    assert!(
        amount.is_some(),
        "attached_deposit event should have amount field"
    );
...
async fn test_second_write_does_not_emit_sponsor_event() -> anyhow::Result<()> {
    ...
    assert_eq!(
        sponsor_events_1.len(),
        1,
        "First write should emit 1 platform_sponsor event"
    );
