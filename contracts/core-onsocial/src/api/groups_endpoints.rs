...
impl Contract {
    ...
    pub fn get_member_data(&self, group_id: String, member_id: AccountId) -> Option<Value> {
        crate::domain::groups::core::GroupStorage::get_member_data(
            &self.platform,
            &group_id,
            &member_id,
        )
    ...
    pub fn is_blacklisted(&self, group_id: String, user_id: AccountId) -> bool {
        crate::domain::groups::core::GroupStorage::is_blacklisted(
            &self.platform,
            &group_id,
            &user_id,
        )
    ...
    pub fn get_join_request(&self, group_id: String, requester_id: AccountId) -> Option<Value> {
        crate::domain::groups::core::GroupStorage::get_join_request(
            &self.platform,
            &group_id,
            &requester_id,
        )
