...
impl SocialPlatform {
    ...
    pub fn join_group(&mut self, group_id: String, caller: &AccountId) -> Result<(), SocialError> {
        let requested_permissions = crate::groups::kv_permissions::NONE;
        ...
        crate::groups::routing::route_group_operation(
            ...
            |platform| {
                crate::groups::core::GroupStorage::join_group_traditional(
                    platform,
                    &group_id,
                    caller,
                )
    ...
    pub fn leave_group(&mut self, group_id: String, caller: &AccountId) -> Result<(), SocialError> {
        crate::groups::core::GroupStorage::remove_member(self, &group_id, caller, caller)
    }
    ...
    pub fn cancel_join_request(
        ...
        crate::groups::core::GroupStorage::cancel_join_request(self, &group_id, caller)
    }
}
