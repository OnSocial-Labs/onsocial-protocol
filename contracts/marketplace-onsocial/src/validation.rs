//! Stateless input validators — no side effects, no `&self` access.

use crate::*;
use std::collections::HashMap;

/// Validates a royalty map: max 10 recipients, each > 0 bps, total ≤ MAX_ROYALTY_BPS.
...
/// Validates a JSON metadata string: max `MAX_METADATA_LEN` bytes and valid JSON.
...
/// Default value helper for serde `#[serde(default = "crate::default_true")]`.
