//! Stateless entry guards: deposit checks, ownership checks, account hashing.
...
/// Returns the collection-id prefix from a token_id (`"collection_id:serial"`), or `""` for standalone tokens.
