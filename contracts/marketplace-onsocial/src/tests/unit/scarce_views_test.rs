...
fn is_token_valid_revoked_returns_false() {
    ...
    testing_env!(context(creator()).build());
    contract
        .internal_create_collection(&creator(), redeemable_config("rcol"))
        .unwrap();
...
fn is_token_revoked_false_for_active() {
    ...
    testing_env!(context(creator()).build());
    contract
        .internal_create_collection(&creator(), redeemable_config("rcol2"))
        .unwrap();
...
fn is_token_redeemed_false_initially() {
    ...
    testing_env!(context(creator()).build());
    contract
        .internal_create_collection(&creator(), redeemable_config("rcol3"))
        .unwrap();
...
fn is_token_redeemed_after_max_redeems() {
    ...
    testing_env!(context(creator()).build());
    contract
        .internal_create_collection(&creator(), redeemable_config("rcol4"))
        .unwrap();
...
fn get_redeem_info_returns_correct_data() {
    ...
    testing_env!(context(creator()).build());
    contract
        .internal_create_collection(&creator(), redeemable_config("rcol5"))
        .unwrap();
