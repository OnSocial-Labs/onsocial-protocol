...
fn nft_supply_for_collection_after_mint() {
    ...
    contract
        .internal_create_collection(&creator(), minimal_collection_config("ecol"))
        .unwrap();
...
fn nft_tokens_for_collection_returns_minted() {
    ...
    testing_env!(context(creator()).build());
    contract
        .internal_create_collection(&creator(), minimal_collection_config("ecol2"))
        .unwrap();
...
fn nft_tokens_for_collection_pagination() {
    ...
    testing_env!(context(creator()).build());
    contract
        .internal_create_collection(&creator(), minimal_collection_config("ecol3"))
        .unwrap();
