//! Pure pricing helpers: Dutch-auction interpolation and deposit refunds.

use crate::*;

/// Dutch-auction interpolated price at current block timestamp. Returns `floor` if not a Dutch auction or time elapsed.
