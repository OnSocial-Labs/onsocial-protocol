...
pub const MAX_NEP177_TIMESTAMP_MS: u64 = 1_000_000_000_000_000;
...
/// Open token-offer book per scarce. Same buyer may replace; new buyers wait.
pub const MAX_TOKEN_OFFERS: u32 = 10;
