...
impl Contract {
    ...
    // Security/state invariant: revoked tokens are non-transferable; token-level transferability overrides collection default.
    ...
    // Accounting invariant: token-level app_id overrides collection-derived app_id.
