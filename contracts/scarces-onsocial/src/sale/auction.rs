...
impl Contract {
    pub(crate) fn list_native_scarce_auction(
        &mut self,
        owner_id: &AccountId,
        token_id: &str,
    ...
    pub(crate) fn settle_auction(
        &mut self,
        _actor_id: &AccountId,
        token_id: &str,
    ) -> Result<(), MarketplaceError> {
        self.settle_auction_impl(_actor_id, token_id, false)
    }

    pub(crate) fn settle_auction_buynow(
        &mut self,
        actor_id: &AccountId,
        token_id: &str,
    ) -> Result<(), MarketplaceError> {
        self.settle_auction_impl(actor_id, token_id, true)
    }

    fn settle_auction_impl(
        &mut self,
        _actor_id: &AccountId,
        token_id: &str,
        force_settle: bool,
